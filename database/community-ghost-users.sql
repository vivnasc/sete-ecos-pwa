...
INSERT INTO community_profiles (user_id, display_name, bio, avatar_emoji, is_ghost, iniciais, avatar_color, cidade, personalidade, membro_desde, ecos_activos) VALUES
  ('00000000-ghost-4000-a000-000000000001', 'Graça Mondlane', 'Mãe de três, de Maputo. O Vitalis devolveu-me a energia que achava perdida.', '🌺', TRUE, 'GM', '{"bg":"#D97706","text":"#FFF"}', 'Maputo', 'calorosa', '2025-09-14', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000002', 'Esperança Nhaca', 'Professora em Matola. A ensinar e a aprender todos os dias.', '📚', TRUE, 'EN', '{"bg":"#B45309","text":"#FFF"}', 'Matola', 'reflexiva', '2025-10-02', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000003', 'Celeste Macuácua', 'Enfermeira na Beira. Cuido dos outros, agora aprendo a cuidar de mim.', '🕊️', TRUE, 'CM', '{"bg":"#92400E","text":"#FFF"}', 'Beira', 'empática', '2025-08-20', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000004', 'Amina Hassane', 'De Nampula. O Vitalis ensinou-me a alimentar o corpo com intenção e gratidão.', '🌙', TRUE, 'AH', '{"bg":"#DC2626","text":"#FFF"}', 'Nampula', 'sabia', '2025-07-15', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000005', 'Fátima Sitoe', 'Empreendedora em Maputo. A equilibrar negócio e alma.', '✨', TRUE, 'FS', '{"bg":"#9333EA","text":"#FFF"}', 'Maputo', 'determinada', '2025-06-10', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000006', 'Halima Januário', 'Mãe e comerciante na Ilha de Moçambique. A cuidar de mim para cuidar dos meus.', '🕊️', TRUE, 'HJ', '{"bg":"#059669","text":"#FFF"}', 'Ilha de Moçambique', 'calorosa', '2025-11-05', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000007', 'Dulce Cossa', 'Avó aos 50. Nunca é tarde para recomeçar. Cada dia é uma nova semente.', '🌸', TRUE, 'DC', '{"bg":"#0891B2","text":"#FFF"}', 'Inhambane', 'sabia', '2025-05-22', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000008', 'Aisha Momade', 'Farmacêutica em Maputo. Descobri no Lumina padrões que não via há anos.', '🌟', TRUE, 'AM', '{"bg":"#BE185D","text":"#FFF"}', 'Maputo', 'curiosa', '2025-09-28', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000009', 'Zainab Mussá', 'Professora em Pemba. A transformação começa no prato e no coração.', '💫', TRUE, 'ZM', '{"bg":"#7C3AED","text":"#FFF"}', 'Pemba', 'determinada', '2025-12-01', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000010', 'Mariamo Abdala', 'Nascida em Angoche. O caminho do autoconhecimento não tem pressa.', '🌷', TRUE, 'MA', '{"bg":"#EA580C","text":"#FFF"}', 'Angoche', 'poetica', '2025-10-18', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000011', 'Joana Tembe', 'Depois de uma fase difícil, estou a renascer. Maputo é a minha raiz.', '🌱', TRUE, 'JT', '{"bg":"#0D9488","text":"#FFF"}', 'Maputo', 'vulneravel', '2026-01-08', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000012', 'Luísa Cumbane', 'Artista plástica em Xai-Xai. Encontro nos Ecos cores que não sabia que tinha.', '🎨', TRUE, 'LC', '{"bg":"#4338CA","text":"#FFF"}', 'Xai-Xai', 'criativa', '2025-08-03', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000013', 'Rosa Mabjaia', 'Nutricionista em formação. O Vitalis é o meu laboratório interior.', '🍃', TRUE, 'RM', '{"bg":"#C026D3","text":"#FFF"}', 'Maputo', 'pratica', '2025-07-20', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000014', 'Beatriz Nhambi', 'De Chimoio. O caminho da cura começa por dentro.', '💜', TRUE, 'BN', '{"bg":"#15803D","text":"#FFF"}', 'Chimoio', 'corajosa', '2025-11-12', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000015', 'Safira Langa', 'Estudante de psicologia na UEM. Fascinada pelo autoconhecimento.', '🔮', TRUE, 'SL', '{"bg":"#A16207","text":"#FFF"}', 'Maputo', 'curiosa', '2025-09-05', '{lumina}'),
  ('00000000-ghost-4000-a000-000000000016', 'Nhara Guambe', 'Runner e amante de chás. A descobrir o meu ritmo entre Matola e o mar.', '🍵', TRUE, 'NG', '{"bg":"#7E22CE","text":"#FFF"}', 'Matola', 'energetica', '2025-10-30', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000017', 'Inês Chissano', 'Jornalista freelancer. As palavras curam quando são verdadeiras.', '🖊️', TRUE, 'IC', '{"bg":"#DB2777","text":"#FFF"}', 'Maputo', 'articulada', '2025-06-28', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000018', 'Marta Chiziane', 'Yoga e meditação em Vilankulo. Este mar é o meu jardim.', '🧘', TRUE, 'MC', '{"bg":"#0E7490","text":"#FFF"}', 'Vilankulo', 'espiritual', '2025-08-15', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000019', 'Ana Macie', 'Cozinheira de coração. A comida tradicional é a minha meditação.', '🍲', TRUE, 'AM', '{"bg":"#B91C1C","text":"#FFF"}', 'Quelimane', 'pratica', '2025-12-20', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000020', 'Cláudia Dzucula', 'Contabilista que descobriu que os números da alma importam mais.', '📊', TRUE, 'CD', '{"bg":"#6D28D9","text":"#FFF"}', 'Maputo', 'reflexiva', '2025-11-25', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000021', 'Rafael Tembe', 'Personal trainer em Maputo. Descobri que treinar o corpo sem nutrir a mente é só metade do caminho.', '💪', TRUE, 'RT', '{"bg":"#1E40AF","text":"#FFF"}', 'Maputo', 'determinada', '2025-10-10', '{vitalis}'),
  ('00000000-ghost-4000-a000-000000000022', 'Dinis Machanguana', 'Engenheiro na Matola. A cuidar da saúde por mim e pelos meus filhos.', '🛠️', TRUE, 'DM', '{"bg":"#065F46","text":"#FFF"}', 'Matola', 'pratica', '2025-12-15', '{vitalis,lumina}'),
  ('00000000-ghost-4000-a000-000000000023', 'Dina Matsombe', 'Designer em Maputo. A criar a minha melhor versão.', '🎨', TRUE, 'DT', '{"bg":"#9333EA","text":"#FFF"}', 'Maputo', 'criativa', '2026-01-15', '{vitalis}')
