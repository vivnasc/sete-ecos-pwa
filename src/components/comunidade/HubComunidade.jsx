...
const ESPACOS = [
  ...
  },
  {
    ...
    desc: 'Pequenos grupos de 7 a 12 mulheres que exploram o mesmo Eco. Um espaço íntimo de partilha e apoio mútuo.',
  ...
  },
  {
    ...
    emoji: '💜',
    titulo: 'Sussurros',
    desc: 'Mensagens privadas de apoio. Não são DMs — são sussurros de encorajamento entre mulheres que caminham juntas.',
