...
const EXERCICIOS = {
  ...
  hack_squat: {
    ...
    erros: ['Joelhos colapsam para dentro', 'Amplitude insuficiente', 'Peso excessivo'],
  ...
  abducao_maquina: {
    ...
    grupo: 'Membros Inferiores',
    subgrupo: 'Glúteos (lateral)',
    local: 'ginasio',
    dificuldade: 'Iniciante',
    musculos: ['Glúteo Médio', 'Glúteo Mínimo', 'Tensor Fáscia Lata'],
    ...
    instrucoes: [
      'Sentada, costas apoiadas',
      'Joelhos nos apoios laterais',
      'Abre as pernas contra a resistência',
      'Mantém contracção 1-2s',
      'Retorna controlado'
    ],
    erros: ['Movimento brusco', 'Não contrair no fim', 'Inclinar tronco'],
    video: 'https://www.youtube.com/watch?v=FgKNPjHOOhI',
    video_canal: 'Jeff Nippard',
    icon: '🦵',
    fase_minima: 'transicao'
  },
  aducao_maquina: {
    id: 'aducao_maquina',
    nome: 'Adução na Máquina',
    grupo: 'Membros Inferiores',
    subgrupo: 'Adutores',
    local: 'ginasio',
    dificuldade: 'Iniciante',
    musculos: ['Adutores', 'Grácil', 'Pectíneo'],
    ...
    instrucoes: [
      'Sentada, costas apoiadas',
      'Pernas abertas nos apoios',
      'Fecha as pernas contra a resistência',
      'Mantém contracção 1-2s',
      'Abre controlado'
    ],
    erros: ['Movimento rápido', 'Não manter postura', 'Usar impulso'],
    video: 'https://www.youtube.com/watch?v=1LYbpCyjnQE',
    video_canal: 'Jeff Nippard',
    icon: '🦵',
    fase_minima: 'transicao'
  },
  elevacao_panturrilha: {
    ...
    instrucoes: [
      'Em pé na plataforma',
      'Calcanhares para fora da borda',
      'Sobe na ponta dos pés',
      'Máxima contracção no topo',
      'Desce até alongar bem'
    ],
    erros: ['Amplitude curta', 'Movimento rápido', 'Não esticar no fundo'],
  ...
  panturrilha_sentada: {
    id: 'panturrilha_sentada',
    nome: 'Panturrilha Sentada',
    grupo: 'Membros Inferiores',
    subgrupo: 'Gémeos (sóleo)',
    local: 'ginasio',
    dificuldade: 'Iniciante',
    musculos: ['Sóleo'],
    ...
    calorias_min: 3,
    instrucoes: [
      'Sentada, joelhos sob o apoio',
      'Bola do pé na plataforma',
      'Eleva os calcanhares',
      'Contrai no topo 2s',
      'Desce alongando bem'
    ],
    erros: ['Peso excessivo', 'Amplitude curta', 'Movimento rápido'],
  ...
  glute_kickback: {
    ...
    local: 'ginasio',
    dificuldade: 'Iniciante',
    musculos: ['Glúteo Máximo', 'Isquiotibiais'],
    equipamento: 'Máquina Glute Kickback',
    series: 3,
    repeticoes: '12-15 cada perna',
    descanso: '45s',
    calorias_min: 5,
    instrucoes: [
      'Apoio nos antebraços',
      'Uma perna na plataforma',
      'Empurra para trás e para cima',
      'Contrai glúteo no topo',
      'Retorna controlado'
    ],
    erros: ['Arquear lombar', 'Movimento brusco', 'Não contrair glúteo'],
    video: 'https://www.youtube.com/watch?v=uU_aa4tWGkw',
    video_canal: 'Jeff Nippard',
    icon: '🍑',
    fase_minima: 'transicao'
  },
  agachamento_smith: {
    ...
    calorias_min: 8,
    instrucoes: [
      'Barra nos ombros/trapézio',
      'Pés ligeiramente à frente',
      'Pés à largura dos ombros',
      'Desce até coxas paralelas',
      'Empurra pelos calcanhares'
    ],
    erros: ['Pés muito atrás', 'Joelhos colapsam', 'Inclinar tronco'],
    video: 'https://www.youtube.com/watch?v=IGbXEeVJuPs',
    video_canal: 'Jeff Nippard',
    icon: '🏋️‍♀️',
    fase_minima: 'transicao'
  },
  stiff: {
    ...
    calorias_min: 8,
    instrucoes: [
      'Em pé, pernas quase esticadas',
      'Barra/halteres à frente',
      'Costas SEMPRE neutras',
      'Desce levando anca para trás',
      'Sente alongamento nos isquios',
      'Sobe contraindo glúteos'
    ],
    erros: ['Arredondar costas', 'Dobrar joelhos demais', 'Descer rápido'],
  ...
  afundo_smith: {
    ...
    instrucoes: [
      'Barra nos ombros',
      'Pé da frente avançado',
      'Pé de trás atrás em linha',
      'Desce verticalmente',
      'Joelho quase toca o chão'
    ],
    erros: ['Joelho passa do pé', 'Inclinar para frente', 'Passo curto'],
    video: 'https://www.youtube.com/watch?v=9kzfBG7eJFI',
    video_canal: 'Buff Dudes',
    icon: '🚶‍♀️',
    fase_minima: 'transicao'
  },
  cadeira_flexora: {
    ...
    instrucoes: [
      'Sentada, costas apoiadas',
      'Almofada sobre os tornozelos',
      'Flexiona os joelhos para baixo',
      'Contrai isquios no fim',
      'Retorna controlado'
    ],
    erros: ['Usar impulso', 'Amplitude curta', 'Movimento rápido'],
    video: 'https://www.youtube.com/watch?v=Orxowest56U',
    video_canal: 'ScottHermanFitness',
    icon: '🦵',
    fase_minima: 'transicao'
  },
