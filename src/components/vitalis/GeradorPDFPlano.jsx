...
// Logo SVG do Vitalis
const VITALIS_LOGO_SVG = `
<svg viewBox="0 0 100 100" xmlns="http://www.w3.org/2000/svg">
  <defs>
    <linearGradient id="logoGrad" x1="0%" y1="0%" x2="100%" y2="100%">
      <stop offset="0%" style="stop-color:#C1634A"/>
      <stop offset="100%" style="stop-color:#8B4513"/>
    </linearGradient>
  </defs>
  <circle cx="50" cy="50" r="48" fill="url(#logoGrad)"/>
  <text x="50" y="68" text-anchor="middle" fill="white" font-family="Georgia, serif" font-size="52" font-weight="bold">V</text>
</svg>
`;
