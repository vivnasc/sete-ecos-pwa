...
export default function RefeicoesCofig() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#F5F0E8] via-[#FDF8F3] to-[#F0EBE3]">
      {/* Header */}
      <div className="bg-[var(--fnx-ink)] shadow-lg">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            ...
            <button
              ...
              className="px-6 py-3 bg-[var(--fnx-ink)] text-white rounded-xl font-semibold hover:shadow-lg transition-all disabled:opacity-50"
            >
              {saving ? '...' : '+ Adicionar'}
            </button>
          </div>
