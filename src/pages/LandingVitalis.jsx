    ...
    <div className="min-h-screen" style={{ fontFamily: 'var(--font-corpo)', background: 'linear-gradient(to bottom, #F5F2ED, #E8E4DC, #C5D1BC)' }}>
      <SEOHead
        ...
        jsonLd={{
          ...
          "description": "Coaching nutricional personalizado baseado no método Precision Nutrition com app completa, receitas e apoio emocional.",
          ...
          "review": [
            ...
            { "@type": "Review", "reviewRating": { "@type": "Rating", "ratingValue": "5" }, "reviewBody": "O Espaço de Retorno mudou tudo. Percebi que comia por ansiedade." }
          ]
        }}
      />
      {/* Navegacao */}
        ...
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="flex justify-center mb-6">
            <PartilharSocial
              ...
              texto="Descobre o VITALIS, coaching nutricional com app completa, receitas e apoio emocional único."
            />
          </div>
