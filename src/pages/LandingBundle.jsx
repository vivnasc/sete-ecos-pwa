...
export default function LandingBundle() {
  ...
  const faqs = [
    ...
    },
    {
      ...
      a: 'Aceitas M-Pesa, e-Mola e transferência bancária. O pagamento é processado de forma segura e recebes acesso imediato.',
    },
    {
        ...
        <section id="precos" className="py-16 bg-gradient-to-br from-[#2D3A25] to-[#3D4A2F] text-white">
          <div className="max-w-6xl mx-auto px-4">
            ...
            <p className="text-center text-white/60 mt-8 text-sm">
              💳 Aceitas M-Pesa, e-Mola e transferência bancária • 🔒 Pagamento 100% seguro
            </p>
          </div>
        </section>
