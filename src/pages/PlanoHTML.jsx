...
export default function PlanoHTML() {
  ...
  if (loading) return (
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',background:'#FDF8F3'}}>
      <div style={{textAlign:'center'}}>
        <div style={{width:'60px',height:'60px',border:'4px solid #f3f3f3',borderTop:'4px solid #C1634A',borderRadius:'50%',animation:'spin 1s linear infinite',margin:'0 auto'}}></div>
        <p style={{marginTop:'20px',color:'#8B4513'}}>A preparar o teu plano...</p>
  ...
  if (!dados) return (
    <div style={{minHeight:'100vh',display:'flex',alignItems:'center',justifyContent:'center',background:'#FDF8F3'}}>
      <div style={{textAlign:'center',color:'#C62828'}}>
        ...
        <button onClick={() => window.close()} style={{marginTop:'20px',padding:'10px 30px',background:'#C1634A',color:'white',border:'none',borderRadius:'8px',cursor:'pointer'}}>Fechar</button>
      </div>
    </div>
  );
  ...
  const PageHeader = () => (
    <div style={{display:'flex',justifyContent:'space-between',alignItems:'center',borderBottom:'2px solid #D2B48C',paddingBottom:'12px',marginBottom:'25px'}}>
      <div style={{display:'flex',alignItems:'center',gap:'12px'}}>
        <Logo size={40} />
        <span style={{fontWeight:'600',fontSize:'18px',color:'#C1634A',letterSpacing:'3px'}}>VITALIS</span>
      </div>
  ...
  const PageFooter = ({ page }) => (
    <div style={{position:'absolute',bottom:'20px',left:'45px',right:'45px',display:'flex',justifyContent:'space-between',fontSize:'9px',color:'#8B4513',borderTop:'1px solid #D2B48C',paddingTop:'10px'}}>
    ...
    <>
      <style>{`
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .page { width: 210mm; min-height: 297mm; background: #FDF8F3; position: relative; overflow: hidden; margin: 0 auto; }
      ...
      <div className="no-print" style={{position:'fixed',bottom:'30px',right:'30px',zIndex:1000,display:'flex',gap:'10px'}}>
        <button onClick={() => window.print()} style={{padding:'15px 30px',background:'linear-gradient(135deg, #C1634A, #8B4513)',color:'white',border:'none',borderRadius:'12px',fontSize:'16px',fontWeight:'600',cursor:'pointer',boxShadow:'0 5px 20px rgba(193,99,74,0.4)',display:'flex',alignItems:'center',gap:'10px'}}>
      ...
      <div className="page" style={{display:'flex',flexDirection:'column'}}>
        <div style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'50px'}}>
          <Logo size={140} />
          <div style={{fontSize:'14px',color:'#8B4513',letterSpacing:'6px',marginTop:'15px'}}>A RAIZ DA TRANSFORMAÇÃO</div>
      ...
      <div className="page" style={{padding:'45px'}}>
        <PageHeader />
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'20px'}}>👋 Bem-vinda à Tua Jornada</div>
        <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px',marginBottom:'18px'}}><p style={{fontSize:'15px',lineHeight:'2'}}><strong>{dados.nome}</strong>, este guia foi criado especialmente para ti, com base nas tuas respostas, objectivos e estilo de vida. Cada porção, cada recomendação, foi calculada para o teu corpo e para onde queres chegar.</p></div>
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'20px',marginTop:'30px'}}>🔥 {faseConfig.nome}</div>
        <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px',marginBottom:'18px'}}><span style={{display:'inline-block',padding:'8px 20px',background:'#F5F0E8',borderRadius:'20px',fontSize:'12px',marginBottom:'15px'}}>Duração: {faseConfig.duracao}</span><p style={{fontSize:'15px',lineHeight:'1.9'}}>{faseConfig.descricao}</p></div>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'20px',marginTop:'28px'}}>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontSize:'11px',color:'#C1634A',letterSpacing:'2px',marginBottom:'12px'}}>ABORDAGEM NUTRICIONAL</div><div style={{fontSize:'26px',fontWeight:'600',color:'#A0422A',textTransform:'capitalize'}}>{dados.abordagem?.replace('_', ' ')}</div></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontSize:'11px',color:'#C1634A',letterSpacing:'2px',marginBottom:'12px'}}>META SEMANAL</div><div style={{fontSize:'26px',fontWeight:'600',color:'#6B8E23'}}>-0.5 a -1.0 kg</div></div>
        </div>
        <PageFooter page={2} />
      </div>
      ...
      <div className="page" style={{padding:'45px'}}>
        <PageHeader />
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'20px'}}>🍽️ As Tuas Porções Diárias</div>
        ...
        <div style={{fontSize:'20px',fontWeight:'600',color:'#6B4423',marginBottom:'20px'}}>📊 Os Teus Macros Diários</div>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr 1fr 1fr',gap:'15px'}}>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',textAlign:'center',padding:'20px'}}><div style={{fontSize:'24px',marginBottom:'12px'}}>🔥</div><div style={{fontSize:'28px',fontWeight:'700',color:'#C1634A'}}>{dados.calorias}</div><div style={{fontSize:'12px',color:'#8B4513',marginTop:'8px'}}>Calorias</div></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',textAlign:'center',padding:'20px'}}><div style={{fontSize:'24px',marginBottom:'12px'}}>🥩</div><div style={{fontSize:'28px',fontWeight:'700',color:'#C62828'}}>{dados.proteina_g}g</div><div style={{fontSize:'12px',color:'#8B4513',marginTop:'8px'}}>Proteína</div></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',textAlign:'center',padding:'20px'}}><div style={{fontSize:'24px',marginBottom:'12px'}}>🍚</div><div style={{fontSize:'28px',fontWeight:'700',color:'#1565C0'}}>{dados.carboidratos_g}g</div><div style={{fontSize:'12px',color:'#8B4513',marginTop:'8px'}}>Hidratos</div></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',textAlign:'center',padding:'20px'}}><div style={{fontSize:'24px',marginBottom:'12px'}}>🥑</div><div style={{fontSize:'28px',fontWeight:'700',color:'#F57F17'}}>{dados.gordura_g}g</div><div style={{fontSize:'12px',color:'#8B4513',marginTop:'8px'}}>Gordura</div></div>
        </div>
        <PageFooter page={3} />
      </div>
      ...
      <div className="page" style={{padding:'45px'}}>
        <PageHeader />
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'20px'}}>✋ O Método da Mão</div>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'25px'}}>
          <div style={{background:'linear-gradient(135deg, #FFEBEE, #FFCDD2)',border:'3px solid #E57373',borderRadius:'18px',padding:'32px'}}><div style={{fontWeight:'600',color:'#C62828',marginBottom:'15px',fontSize:'19px'}}>🖐️ A Palma — PROTEÍNA</div><div style={{color:'#C62828',fontWeight:'700',fontSize:'26px',marginBottom:'15px'}}>~{dados.tamanho_palma}g de proteína</div><p style={{fontSize:'14px',color:'#6B4423',marginBottom:'12px'}}>Tamanho e espessura da tua palma (sem dedos)</p><p style={{fontSize:'13px',color:'#8B4513',fontStyle:'italic'}}>Ex: 1 bife, 1 peito de frango</p></div>
          ...
          <div style={{background:'linear-gradient(135deg, #E8F5E9, #C8E6C9)',border:'3px solid #81C784',borderRadius:'18px',padding:'32px'}}><div style={{fontWeight:'600',color:'#2E7D32',marginBottom:'15px',fontSize:'19px'}}>✊ O Punho — VEGETAIS</div><div style={{color:'#2E7D32',fontWeight:'700',fontSize:'26px',marginBottom:'15px'}}>~100g de vegetais</div><p style={{fontSize:'14px',color:'#6B4423',marginBottom:'12px'}}>Tamanho do teu punho fechado</p><p style={{fontSize:'13px',color:'#2E7D32',fontWeight:'600'}}>Mas lembra-te: À VONTADE!</p></div>
        </div>
        <PageFooter page={4} />
      </div>
      ...
      <div className="page" style={{padding:'45px'}}>
        <PageHeader />
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'25px'}}>🥩 Proteínas Saudáveis</div>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'20px'}}>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontWeight:'600',color:'#C1634A',marginBottom:'18px',fontSize:'17px',borderBottom:'2px solid #D2B48C',paddingBottom:'12px'}}>Carnes Vermelhas (magras)</div><p style={{fontSize:'15px',lineHeight:'2.3'}}>Bife de vaca • Carne moída magra • Lombo de porco • Cabrito • Borrego • Fígado</p></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontWeight:'600',color:'#C1634A',marginBottom:'18px',fontSize:'17px',borderBottom:'2px solid #D2B48C',paddingBottom:'12px'}}>Aves</div><p style={{fontSize:'15px',lineHeight:'2.3'}}>Peito de frango • Coxa de frango (sem pele) • Peru • Pato (sem pele) • Codorniz</p></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontWeight:'600',color:'#C1634A',marginBottom:'18px',fontSize:'17px',borderBottom:'2px solid #D2B48C',paddingBottom:'12px'}}>Peixes & Mariscos</div><p style={{fontSize:'15px',lineHeight:'2.3'}}>Salmão • Atum • Sardinha • Carapau • Pescada • Tilápia • Camarão • Lulas</p></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontWeight:'600',color:'#C1634A',marginBottom:'18px',fontSize:'17px',borderBottom:'2px solid #D2B48C',paddingBottom:'12px'}}>Ovos & Lacticínios</div><p style={{fontSize:'15px',lineHeight:'2.3'}}>Ovos inteiros • Queijo fresco • Iogurte grego natural • Requeijão • Queijo cottage</p></div>
        </div>
        <PageFooter page={5} />
      </div>
      ...
      <div className="page" style={{padding:'45px'}}>
        <PageHeader />
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'25px'}}>🍚 Hidratos Saudáveis & 🥑 Gorduras</div>
      ...
      <div className="page" style={{padding:'45px'}}>
        <PageHeader />
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'20px'}}>🥬 Vegetais — Come o Arco-Íris!</div>
        ...
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'18px',marginBottom:'18px'}}>
          <div style={{background:'linear-gradient(135deg, #F1F8E9, #DCEDC8)',border:'1px solid #D2B48C',borderLeft:'7px solid #4CAF50',borderRadius:'14px',padding:'22px'}}><div style={{fontWeight:'600',color:'#2E7D32',marginBottom:'14px',fontSize:'16px'}}>🟢 Verdes</div><p style={{fontSize:'14px',lineHeight:'1.9'}}>Espinafre, Couve, Brócolos, Alface, Rúcula, Pepino, Abobrinha</p></div>
          <div style={{background:'linear-gradient(135deg, #FFEBEE, #FFCDD2)',border:'1px solid #D2B48C',borderLeft:'7px solid #F44336',borderRadius:'14px',padding:'22px'}}><div style={{fontWeight:'600',color:'#C62828',marginBottom:'14px',fontSize:'16px'}}>🔴 Vermelhos</div><p style={{fontSize:'14px',lineHeight:'1.9'}}>Tomate, Pimento vermelho, Beterraba, Rabanete</p></div>
        </div>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'18px',marginBottom:'18px'}}>
          <div style={{background:'linear-gradient(135deg, #FFF3E0, #FFE0B2)',border:'1px solid #D2B48C',borderLeft:'7px solid #FF9800',borderRadius:'14px',padding:'22px'}}><div style={{fontWeight:'600',color:'#E65100',marginBottom:'14px',fontSize:'16px'}}>🟠 Laranjas</div><p style={{fontSize:'14px',lineHeight:'1.9'}}>Cenoura, Abóbora, Pimento laranja</p></div>
          <div style={{background:'linear-gradient(135deg, #FAFAFA, #F5F5F5)',border:'1px solid #D2B48C',borderLeft:'7px solid #9E9E9E',borderRadius:'14px',padding:'22px'}}><div style={{fontWeight:'600',color:'#616161',marginBottom:'14px',fontSize:'16px'}}>⚪ Brancos</div><p style={{fontSize:'14px',lineHeight:'1.9'}}>Couve-flor, Cogumelos, Alho, Cebola, Nabo</p></div>
        </div>
        <div style={{background:'linear-gradient(135deg, #F3E5F5, #E1BEE7)',border:'1px solid #D2B48C',borderLeft:'7px solid #9C27B0',borderRadius:'14px',padding:'22px'}}><div style={{fontWeight:'600',color:'#6A1B9A',marginBottom:'14px',fontSize:'16px'}}>🟣 Roxos</div><p style={{fontSize:'14px',lineHeight:'1.9'}}>Beringela, Couve roxa, Cebola roxa</p></div>
        <PageFooter page={7} />
      </div>
      ...
      <div className="page" style={{padding:'45px'}}>
        <PageHeader />
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'25px'}}>🛒 Lista de Compras Semanal</div>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'20px'}}>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontWeight:'600',color:'#C62828',marginBottom:'20px',fontSize:'17px',borderBottom:'2px solid #E57373',paddingBottom:'12px'}}>🥩 Proteínas</div><div style={{fontSize:'15px',lineHeight:'2.6'}}>☐ Peito de frango (1kg)<br/>☐ Ovos (2 dúzias)<br/>☐ Peixe fresco (500g)<br/>☐ Carne moída magra (500g)</div></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontWeight:'600',color:'#2E7D32',marginBottom:'20px',fontSize:'17px',borderBottom:'2px solid #81C784',paddingBottom:'12px'}}>🥬 Vegetais</div><div style={{fontSize:'15px',lineHeight:'2.6'}}>☐ Espinafre/Couve<br/>☐ Brócolos<br/>☐ Tomate<br/>☐ Pepino<br/>☐ Pimentos<br/>☐ Cebola e Alho</div></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontWeight:'600',color:'#F57F17',marginBottom:'20px',fontSize:'17px',borderBottom:'2px solid #FFD54F',paddingBottom:'12px'}}>🥑 Gorduras</div><div style={{fontSize:'15px',lineHeight:'2.6'}}>☐ Azeite extra-virgem<br/>☐ Abacate (2-3)<br/>☐ Manteiga<br/>☐ Amêndoas/Nozes</div></div>
          <div style={{background:'white',border:'1px solid #D2B48C',borderRadius:'14px',padding:'25px'}}><div style={{fontWeight:'600',color:'#8B4513',marginBottom:'20px',fontSize:'17px',borderBottom:'2px solid #D2B48C',paddingBottom:'12px'}}>🧂 Outros</div><div style={{fontSize:'15px',lineHeight:'2.6'}}>☐ Sal e pimenta<br/>☐ Ervas frescas<br/>☐ Limões<br/>☐ Chá/Café</div></div>
        </div>
        <PageFooter page={8} />
      </div>
      ...
      <div className="page" style={{padding:'45px'}}>
        <PageHeader />
        <div style={{fontSize:'24px',fontWeight:'600',color:'#6B4423',marginBottom:'25px'}}>📋 Regras da {faseConfig.nome}</div>
        <div style={{display:'grid',gridTemplateColumns:'1fr 1fr',gap:'20px',marginBottom:'22px'}}>
      ...
      <div className="page" style={{display:'flex',flexDirection:'column'}}>
        <div style={{flex:1,display:'flex',flexDirection:'column',alignItems:'center',justifyContent:'center',padding:'55px'}}>
          <Logo size={140} />
          <div style={{fontSize:'14px',color:'#8B4513',letterSpacing:'6px',marginTop:'15px',marginBottom:'65px'}}>A RAIZ DA TRANSFORMAÇÃO</div>
