...
// =================================================================
// CAMPANHA DE LANÇAMENTO — CRONOGRAMA 17 DIAS
// Estratégia: alternar CARROSSEL (engagement) + REEL (discovery)
// Áudio ElevenLabs em TODOS os posts (carrosséis com áudio
// aparecem no feed de Reels = duplica alcance)
// =================================================================
// ALGORITMO IG 2026:
// - Sends/DMs = sinal #1 para alcance
// - Carrosséis: 1.9x mais reach, 95% mais saves que posts estáticos
// - Reels: discovery engine para não-seguidores
// - Watch time + completion rate decidem distribuição
// - Caption dwell time agora é tracked
// - Mix ideal: 3-4 Reels/sem + 2-3 carrosséis + 1-2 estáticos
// =================================================================

const LANCAMENTO_POSTS = [

  // =================================================================
  // SEMANA 1: IDENTIDADE + LUMINA (Posts 1-6)
  // Objectivo: parar o scroll, gerar saves/shares, criar identidade
  // =================================================================

  {
    dia: 1,
    fase: 1,
    faseTitulo: 'Identidade & Isca',
    audioSlug: 'mkt-lz-lc-01-fragmentada',
    titulo: '5 sinais de que a tua vida está fragmentada',
    eco: 'seteEcos',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL educativo — publica de manhã (9h-10h). Formato 1080x1350. Adiciona áudio com voiceover para aparecer nos Reels.',
    hook: 'Se isto soa familiar, guarda este post.',
    corpo: 'Cuidas do corpo mas ignoras o que sentes.\nTens disciplina mas zero direcção.\nSabes o que fazer mas não fazes.\nEstás sempre cansada mas não é do corpo.\nAjudas toda a gente menos a ti.',
    cta: 'Guarda e envia a quem precisa disto.',
    audioScript: 'Se isto soa familiar, guarda este post. Cuidas do corpo mas ignoras o que sentes. Tens disciplina mas zero direcção. Sabes o que fazer mas não fazes. Estás sempre cansada, mas não é do corpo. Ajudas toda a gente. Menos a ti. Se reconheces 3 ou mais, a tua vida não precisa de mais informação. Precisa de integração. Guarda e envia a quem precisa disto.',
    instagram: { caption: 'Se reconheces 3 ou mais, a tua vida não precisa de mais informação. Precisa de integração.\n\nGuarda este post. Envia a quem precisa.\n\n— Vivianne\n\n#autoconhecimento #bemestar #saúdemental #cansaço #integração #transformação #seteecos' },
    facebook: '5 sinais de que a tua vida está fragmentada:\n\n1. Cuidas do corpo mas ignoras o que sentes\n2. Tens disciplina mas zero direcção\n3. Sabes o que fazer mas não fazes\n4. Estás sempre cansada mas não é do corpo\n5. Ajudas toda a gente menos a ti\n\nSe reconheces 3 ou mais, precisa de integração — não de mais informação.\n\n— Vivianne',
    whatsapp: '5 sinais de que a tua vida está fragmentada:\n\n1. Cuidas do corpo mas ignoras o que sentes\n2. Tens disciplina mas zero direcção\n3. Sabes o que fazer mas não fazes\n4. Cansaço que não é do corpo\n5. Ajudas toda a gente menos a ti\n\nReconheces? 👉 app.seteecos.com/lumina (grátis, 2 min)',
    tiktok: { ideia: 'CARROSSEL com áudio — voz por cima dos slides. Música suave trending de fundo. Cada slide aparece 3-4 segundos. Texto grande, fundo escuro.', caption: 'Se reconheces 3 ou mais... #autoconhecimento #saúdemental #fyp #seteecos' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: '5 sinais de vida fragmentada',
      texto: 'Se isto soa familiar, guarda este post.',
      subtitulo: 'Guarda e envia a quem precisa.',
      caption: '',
      slides: [
        { titulo: '5 sinais de que a tua vida está fragmentada', texto: 'Reconheces algum? Desliza →' },
        { titulo: '1. Cuidas do corpo mas ignoras o que sentes', texto: 'Fazes dieta, exercício, rotinas. Mas o que sentes por dentro? Isso ninguém toca.' },
        { titulo: '2. Tens disciplina mas zero direcção', texto: 'Acordas cedo. Trabalhas duro. Mas para quê? A disciplina sem propósito é só cansaço disfarçado.' },
        { titulo: '3. Sabes o que fazer mas não fazes', texto: 'Leste os livros. Viste os vídeos. Mas entre saber e fazer há um abismo que a informação não resolve.' },
        { titulo: '4. Estás sempre cansada mas não é do corpo', texto: 'Dormes e acordas cansada. Não é sono que falta. É coerência entre o que vives e o que precisas.' },
        { titulo: '5. Ajudas toda a gente menos a ti', texto: 'Para os filhos, o trabalho, o parceiro — sempre disponível. Para ti? "Depois vejo isso."' },
        { titulo: 'Se reconheces 3 ou mais...', texto: 'Não precisas de mais informação.\nPrecisas de integração.\n\nGuarda e envia a quem precisa.\n\napp.seteecos.com' },
      ],
    },
    dica: 'CARROSSEL de 7 slides. Formato 1080x1350 (4:5). Fundo escuro roxo. Texto grande e legível. ADICIONA ÁUDIO (voiceover ElevenLabs) — carrosséis com áudio aparecem no feed de Reels, duplicando alcance.',
  },

  {
    ...
    fase: 1,
    faseTitulo: 'Identidade & Isca',
    audioSlug: 'mkt-lz-lc-02-cansaco',
    titulo: 'O teu cansaço não é do corpo.',
    eco: 'seteEcos',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL 60-90s — publica entre 11h-13h. Texto em ecrã + voiceover. Música calma trending.',
    hook: 'Estás exausta. Mas não é do corpo.',
    corpo: 'Dormes 7 horas e acordas destruída.\nComes bem e continuas sem energia.\nFazes exercício e mesmo assim arrastas-te.\n\nE se o cansaço não for físico?\nE se for falta de integração entre o que vives, o que sentes e o que precisas?\n\nO corpo fala. Mas não só de comida e sono.',
    cta: 'Faz o teste grátis — 2 minutos. Link na bio.',
    audioScript: 'Estás exausta. Mas não é do corpo. Dormes 7 horas e acordas destruída. Comes bem e continuas sem energia. Fazes exercício e mesmo assim arrastas-te. E se o cansaço não for físico? E se for falta de integração entre o que vives, o que sentes, e o que precisas? O corpo fala. Mas não só de comida e sono. Faz o diagnóstico grátis. 2 minutos. Link na bio.',
    instagram: { caption: 'Se dormes e acordas cansada, o problema pode não ser o sono.\n\nPode ser falta de integração entre o que vives, sentes e precisas.\n\nDiagnóstico grátis — 2 minutos — link na bio.\n\n— Vivianne\n\n#cansaço #saúdemental #burnout #energia #bemestar #autoconhecimento #seteecos' },
    facebook: 'Estás exausta. Mas não é do corpo.\n\nDormes. Comes bem. Fazes exercício. E mesmo assim arrastas-te.\n\nE se o cansaço não for físico? Diagnóstico grátis → app.seteecos.com/lumina\n\n— Vivianne',
    whatsapp: 'Estás exausta mas não é do corpo.\n\nE se o cansaço for falta de integração entre o que vives, sentes e precisas?\n\nFaz o teste grátis (2 min): 👉 app.seteecos.com/lumina',
    tiktok: { ideia: 'REEL 60s — Texto em ecrã, palavra a palavra:\n"Estás exausta."\n"Mas não é do corpo."\n[pausa 2s]\n"Dormes 7h. Acordas destruída."\n"Comes bem. Sem energia."\n"Exercício. Arrastas-te."\n[pausa]\n"E se não for físico?"\n"E se for falta de integração?"\n"Teste grátis. 2 minutos. Link na bio."', caption: 'Estás exausta? Talvez não seja do corpo. #cansaço #burnout #energia #fyp #seteecos' },
    conteudoIG: { tipo: 'dica', texto: 'Estás exausta. Mas não é do corpo.', subtitulo: 'Diagnóstico grátis — 2 minutos.', caption: '' },
    dica: 'REEL 60-90s. Texto em ecrã + voiceover ElevenLabs. Fundo escuro. Música calma trending. Cada frase aparece 2-3s. Gancho emocional forte.',
  },

  {
    ...
    fase: 1,
    faseTitulo: 'Identidade & Isca',
    audioSlug: 'mkt-lz-lc-03-corpo-fala',
    titulo: '4 coisas que o teu corpo te está a dizer',
    eco: 'lumina',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL educativo — publica de manhã (9h-10h). O objectivo é SAVES. Conteúdo que as pessoas guardam para reler.',
    hook: 'O teu corpo está a falar. Tu é que não estás a ouvir.',
    corpo: 'Tensão no pescoço? Pode ser o que não dizes.\nDor de estômago constante? Pode ser ansiedade disfarçada.\nInsónia? Pode ser uma decisão que estás a adiar.\nComer sem fome? Pode ser emoção a pedir atenção.',
    cta: 'Guarda isto. Descobre o que o teu corpo diz: link na bio.',
    audioScript: 'O teu corpo está a falar. Tu é que não estás a ouvir. Tensão no pescoço? Pode ser o que não dizes. Dor de estômago constante? Pode ser ansiedade disfarçada. Insónia? Pode ser uma decisão que estás a adiar. Comes sem fome? Pode ser emoção a pedir atenção. Não é fraqueza. É informação. Guarda isto. E descobre o que o teu corpo diz.',
    instagram: { caption: 'O teu corpo está a falar. Tu é que não estás a ouvir.\n\nGuarda este post — vais precisar dele.\n\nDescobre o que o teu corpo diz: link na bio (grátis, 2 min).\n\n— Vivianne\n\n#corpoemente #saúdemental #ansiedade #autoconhecimento #emoções #seteecos #lumina' },
    facebook: 'O teu corpo está a falar. Tu é que não estás a ouvir.\n\nTensão no pescoço = o que não dizes\nDor de estômago = ansiedade disfarçada\nInsónia = decisão adiada\nComer sem fome = emoção a pedir atenção\n\nDescobre o padrão: app.seteecos.com/lumina (grátis)\n\n— Vivianne',
    whatsapp: 'O teu corpo está a falar:\n\n• Tensão no pescoço? O que não dizes.\n• Dor de estômago? Ansiedade disfarçada.\n• Insónia? Decisão adiada.\n• Comes sem fome? Emoção.\n\nDescobre o padrão: 👉 app.seteecos.com/lumina (grátis)',
    tiktok: { ideia: 'CARROSSEL com áudio. Cada slide revela uma ligação corpo-emoção. Voz calma, pausas entre slides.', caption: 'O teu corpo fala. Estás a ouvir? #corpoemente #saúdemental #fyp #seteecos' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: '4 coisas que o teu corpo te diz',
      texto: 'O teu corpo está a falar.',
      subtitulo: 'Guarda isto.',
      caption: '',
      slides: [
        { titulo: 'O teu corpo está a falar.', texto: 'Tu é que não estás a ouvir. Desliza →' },
        { titulo: 'Tensão no pescoço?', texto: 'Pode ser o que não dizes. As palavras engolidas ficam presas no corpo.' },
        { titulo: 'Dor de estômago constante?', texto: 'Pode ser ansiedade disfarçada. O intestino é o segundo cérebro.' },
        { titulo: 'Insónia?', texto: 'Pode ser uma decisão que estás a adiar. A mente não desliga quando há coisas por resolver.' },
        { titulo: 'Comes sem fome?', texto: 'Pode ser emoção a pedir atenção. Não é falta de disciplina. É falta de escuta.' },
        { titulo: 'Não é fraqueza. É informação.', texto: 'Descobre o que o teu corpo diz.\n\nDiagnóstico grátis — 2 minutos.\napp.seteecos.com/lumina' },
      ],
    },
    dica: 'CARROSSEL de 6 slides com áudio voiceover. Objectivo: SAVES. Conteúdo educativo que as pessoas guardam. Fundo indigo para LUMINA.',
  },

  {
    ...
    fase: 1,
    faseTitulo: 'Identidade & Isca',
    audioSlug: 'mkt-lz-lc-04-diagnostico',
    titulo: 'POV: fazes o diagnóstico e descobres o padrão',
    eco: 'lumina',
    template: 'cta',
    formato: 'reel',
    cronograma: 'REEL demo — publica entre 12h-14h. Screen recording do LUMINA no telemóvel + voiceover. Autêntico.',
    hook: 'Fiz isto em 2 minutos. E mudou a forma como me vejo.',
    corpo: 'Screen recording real:\n1. Abrir app.seteecos.com/lumina\n2. Responder às 7 perguntas\n3. Ver o resultado — 23 leituras possíveis\n4. Mostrar a leitura personalizada\n\nNão mede peso. Não conta calorias. Mapeia como estás de verdade.',
    cta: 'Grátis. 2 minutos. Link na bio. Qual é a tua leitura?',
    audioScript: 'Fiz isto em 2 minutos. E mudou a forma como me vejo. São 7 perguntas. Sobre corpo, energia, mente, emoção. Nada de peso. Nada de calorias. E o resultado? 23 leituras possíveis. Cada uma revela um padrão diferente. Eu fiquei chocada com a minha. Experimenta. É grátis. Link na bio.',
    instagram: { caption: 'Fiz isto em 2 minutos. 7 perguntas. 23 leituras possíveis.\n\nNão mede peso. Não conta calorias. Mapeia como estás de verdade.\n\nQual foi a tua leitura? Comenta.\n\nGrátis — link na bio.\n\n— Vivianne\n\n#diagnóstico #autoconhecimento #grátis #saúdemental #bemestar #seteecos #lumina' },
    facebook: 'Fiz isto em 2 minutos e mudou a forma como me vejo.\n\n7 perguntas. 23 leituras possíveis. Não mede peso.\n\nGrátis → app.seteecos.com/lumina\n\n— Vivianne',
    whatsapp: 'Fiz isto em 2 minutos — 7 perguntas, 23 leituras possíveis.\n\nMapeia como estás de verdade. Sem peso, sem calorias.\n\n👉 app.seteecos.com/lumina (grátis)',
    tiktok: { ideia: 'REEL 45-60s — Screen recording real do LUMINA no telemóvel. Voiceover enquanto mostra as perguntas e o resultado. Autêntico, sem edição exagerada.', caption: '2 minutos que mudaram a minha perspectiva #diagnóstico #autoconhecimento #fyp #seteecos' },
    conteudoIG: { tipo: 'cta', texto: 'Fiz isto em 2 minutos.', subtitulo: '23 leituras possíveis. Grátis.', caption: '' },
    dica: 'REEL com screen recording REAL do Lumina no telemóvel. Voiceover ElevenLabs. Autêntico — sem edição exagerada. CTA para comentar qual foi a leitura.',
  },

  {
    ...
    fase: 1,
    faseTitulo: 'Identidade & Isca',
    titulo: 'Preparar os 9 Destaques do Instagram',
    eco: 'lumina',
    template: 'dica',
    formato: 'destaques',
    cronograma: 'TAREFA — Não é um post. Cria os 9 destaques do perfil (1 por eco). Usa as capas geradas abaixo.',
    hook: '9 anéis coloridos no topo do teu perfil — um por cada Eco',
    corpo: 'Os Destaques são os anéis no topo do perfil Instagram. Cada um representa um Eco com a sua cor.\n\nCria uma Story para cada eco (fundo com a cor + nome + emoji). Guarda como Destaque.\n\nQuem visita o perfil vê imediatamente o sistema completo.',
    cta: 'Cria os 9 destaques antes de continuar.',
    audioScript: '',
    instagram: { caption: '' },
    facebook: '',
    whatsapp: '',
    ...
    dica: 'TAREFA — Não é um post público. Cria 9 Stories com fundo na cor do eco + emoji + nome. Guarda cada uma como Destaque.',
  },

  {
    ...
    fase: 1,
    faseTitulo: 'Identidade & Isca',
    audioSlug: 'mkt-lz-lc-06-resolves-tudo',
    titulo: 'Porque é que resolves tudo menos o que sentes?',
    eco: 'seteEcos',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL provocativo — publica entre 18h-20h. Texto em ecrã. Gancho forte nos 3 primeiros segundos.',
    hook: 'Resolves o trabalho. Os filhos. A casa. O jantar. Tudo. Menos o que sentes.',
    corpo: 'Tens solução para tudo.\nMenos para a tua exaustão.\nMenos para aquele vazio que aparece quando paras.\nMenos para a pergunta "e eu?".\n\nPorque cresceste a acreditar que cuidar de ti era egoísmo.\nNão é.\nÉ a fundação de tudo o resto.',
    cta: 'Se isto tocou fundo, guarda. Não estás sozinha.',
    audioScript: 'Resolves o trabalho. Os filhos. A casa. O jantar. Tudo. Menos o que sentes. Tens solução para tudo. Menos para a tua exaustão. Menos para aquele vazio que aparece quando paras. Menos para a pergunta: e eu? Porque cresceste a acreditar que cuidar de ti era egoísmo. Não é. É a fundação de tudo o resto.',
    instagram: { caption: 'Se isto tocou fundo, guarda.\nNão estás sozinha.\n\n— Vivianne\n\n#saúdemental #autocuidado #mães #cansaço #esgotamento #bemestar #seteecos' },
    facebook: 'Resolves o trabalho. Os filhos. A casa. O jantar. Tudo. Menos o que sentes.\n\nCuidar de ti não é egoísmo. É a fundação de tudo o resto.\n\n— Vivianne',
    whatsapp: 'Resolves tudo. Menos o que sentes.\n\nCuidar de ti não é egoísmo. É a fundação de tudo o resto.\n\nDescobre por onde começar: 👉 app.seteecos.com/lumina (grátis)',
    tiktok: { ideia: 'REEL 45s — Texto em ecrã, fundo escuro. Cada frase aparece lentamente. Música emocional trending. Gancho forte: "Resolves tudo. Menos o que sentes."', caption: 'Não estás sozinha. #saúdemental #autocuidado #mães #fyp #seteecos' },
    conteudoIG: { tipo: 'dica', texto: 'Resolves tudo. Menos o que sentes.', subtitulo: 'Cuidar de ti não é egoísmo.', caption: '' },
    dica: 'REEL emocional. Texto em ecrã + voiceover. Música trending suave. Objectivo: SHARES (enviar a amigas). Gancho nos primeiros 2 segundos.',
  },

  // =================================================================
  // SEMANA 2: CORPO & EMOÇÃO — O que ninguém te ensina (Posts 7-11)
  // Objectivo: EDUCAR. Conteúdo que vale por si mesmo. Produto só no fim.
  // Filosofia: "Olhar para dentro para se situar no mundo externo"
  // =================================================================

  {
    dia: 7,
    fase: 2,
    faseTitulo: 'Corpo & Emoção — Educação',
    audioSlug: 'mkt-lz-07-dietas-falham',
    titulo: 'Porque é que as dietas falham (não é o que pensas)',
    eco: 'seteEcos',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL educativo — publica de manhã (9h). 100% EDUCAÇÃO. Zero menção de produto até ao último slide. Objectivo: SAVES.',
    hook: 'As dietas falham. Mas não é por falta de disciplina.',
    corpo: 'As dietas focam-se no QUE comes.\nMas ignoram o PORQUÊ comes.\n\nComes por fome? Ou por stress, solidão, tédio, raiva?\n\nA ciência chama-lhe "fome emocional". E afecta 75% das pessoas que tentam fazer dieta.\n\nEnquanto não entenderes a emoção por trás do garfo, nenhum plano alimentar vai funcionar.',
    cta: 'Guarda. Isto muda a forma como vês a alimentação.',
    audioScript: 'As dietas falham. Mas não é por falta de disciplina. As dietas focam-se no que comes. Mas ignoram o porquê comes. Comes por fome? Ou por stress, solidão, tédio, raiva? A ciência chama-lhe fome emocional. E afecta 75 por cento das pessoas que tentam fazer dieta. Enquanto não entenderes a emoção por trás do garfo, nenhum plano alimentar vai funcionar. Isto não é opinião. É neurociência. O cérebro usa comida como regulador emocional quando não tem outra ferramenta. É por isso que a força de vontade falha. Porque nunca foi um problema de vontade. Foi um problema de consciência.',
    instagram: { caption: 'As dietas falham. Mas não é por falta de disciplina.\n\nÉ porque ignoram o PORQUÊ comes.\n\nGuarda — isto muda tudo.\n\n— Vivianne\n\n#fomeemocional #nutrição #dieta #psicologia #neurociência #saúdemental #educação #seteecos' },
    facebook: 'Porque é que as dietas falham?\n\nNão é falta de disciplina. É porque focam no QUE comes e ignoram o PORQUÊ comes.\n\n75% das pessoas que fazem dieta comem por emoção, não por fome.\n\nEnquanto não entenderes a emoção por trás do garfo, nenhum plano funciona.\n\n— Vivianne',
    whatsapp: 'Sabias que 75% das pessoas que fazem dieta comem por emoção, não por fome?\n\nAs dietas falham porque ignoram o PORQUÊ comes.\n\nIsto muda tudo. Guarda.',
    tiktok: { ideia: 'CARROSSEL com áudio. Voz pausada, tom de professora. Cada slide revela um facto. Música trending calma.', caption: 'Porque é que as dietas falham? Não é o que pensas. #nutrição #dieta #fomeemocional #ciência #fyp' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'Porque as dietas falham',
      texto: 'Não é falta de disciplina.',
      subtitulo: 'É ciência. Guarda isto.',
      caption: '',
      slides: [
        { titulo: 'Porque é que as dietas falham?', texto: 'Não é o que pensas. Desliza →' },
        { titulo: 'As dietas focam-se no QUE comes.', texto: 'Mas ignoram completamente o PORQUÊ comes. E é aí que está o problema.' },
        { titulo: 'Comes por fome? Ou por emoção?', texto: 'Stress, solidão, tédio, raiva, ansiedade. O corpo usa comida como regulador emocional. A ciência chama-lhe fome emocional.' },
        { titulo: '75% das pessoas que fazem dieta comem por emoção.', texto: 'Não é falta de vontade. É o cérebro a procurar conforto onde pode. Dopamina. Serotonina. A comida fornece.' },
        { titulo: 'É por isso que a força de vontade falha.', texto: 'Porque nunca foi um problema de vontade. Foi um problema de consciência. Se não entendes a emoção, repetes o padrão.' },
        { titulo: 'O que muda isto?', texto: 'Aprender a identificar o que sentes ANTES de abrir o frigorífico. Parece simples. Mas ninguém te ensinou.\n\nGuarda. Envia a quem precisa.' },
      ],
    },
    dica: 'CARROSSEL 100% educativo. 6 slides. SEM menção de produto. Ensina neurociência da fome emocional. Objectivo: SAVES (conteúdo guardável).',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'Corpo & Emoção — Educação',
    audioSlug: 'mkt-lz-08-corpo-guarda',
    titulo: 'O teu corpo guarda o que a mente ignora',
    eco: 'seteEcos',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL educativo — publica entre 12h-14h. Texto em ecrã + voiceover. Ensina a ligação corpo-emoção.',
    hook: 'O teu corpo guarda tudo. Mesmo o que finges que não sentes.',
    corpo: 'A raiva que engoles vira tensão no pescoço.\nA tristeza que ignoras vira dor de estômago.\nA ansiedade vira bruxismo enquanto dormes.\nO medo vira insónia.\n\nIsto não é poesia. É psicossomática — a ciência que estuda como as emoções se expressam no corpo.\n\nSe não ouves o que sentes, o corpo grita.',
    cta: 'Se reconheces algum, guarda. O teu corpo está a falar.',
    audioScript: 'O teu corpo guarda tudo. Mesmo o que finges que não sentes. A raiva que engoles vira tensão no pescoço. A tristeza que ignoras vira dor de estômago. A ansiedade vira bruxismo enquanto dormes. O medo vira insónia. Isto não é poesia. É psicossomática. A ciência que estuda como as emoções se expressam no corpo. O teu corpo é o diário que nunca mentes. Se não ouves o que sentes, o corpo grita. Guarda isto. E da próxima vez que tiveres uma dor, pergunta-te: o que estou a sentir?',
    instagram: { caption: 'O teu corpo guarda tudo. Mesmo o que finges que não sentes.\n\nIsto não é poesia. É psicossomática.\n\nGuarda — o teu corpo está a falar.\n\n— Vivianne\n\n#psicossomática #corpoemente #emoções #saúdemental #ciência #autoconhecimento #seteecos' },
    facebook: 'O teu corpo guarda tudo:\n\n• Raiva engolida → tensão no pescoço\n• Tristeza ignorada → dor de estômago\n• Ansiedade → bruxismo\n• Medo → insónia\n\nIsto é psicossomática — ciência real.\n\nDa próxima vez que tiveres uma dor, pergunta: o que estou a sentir?\n\n— Vivianne',
    whatsapp: 'O teu corpo guarda tudo:\n\n• Raiva → tensão no pescoço\n• Tristeza → dor de estômago\n• Ansiedade → bruxismo\n• Medo → insónia\n\nÉ ciência. Chama-se psicossomática.\n\nGuarda isto.',
    tiktok: { ideia: 'REEL 60s — Cada emoção aparece com a zona do corpo correspondente. Fundo escuro. Texto grande. Voiceover calma. Música trending suave.', caption: 'O teu corpo guarda tudo. #psicossomática #emoções #corpoemente #ciência #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'O teu corpo guarda tudo.', subtitulo: 'Isto é ciência, não poesia.', caption: '' },
    dica: 'REEL 100% educativo. Zero produto. Ensina psicossomática de forma acessível. Objectivo: SHARES ("tenho de enviar isto").',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'Corpo & Emoção — Educação',
    audioSlug: 'mkt-lz-09-5-perguntas',
    titulo: '5 perguntas para te conheceres melhor que qualquer teste',
    eco: 'seteEcos',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL interactivo — publica entre 18h-20h. Perguntas que levam à reflexão. Objectivo: SAVES + comentários.',
    hook: 'Estas 5 perguntas revelam mais sobre ti do que qualquer teste de personalidade.',
    corpo: '1. Quando estás em stress, o que fazes PRIMEIRO? (comes, isolaste, trabalhas mais, ficas no telemóvel)\n2. O que evitas há mais de 6 meses?\n3. Se pudesses mudar UMA coisa na tua vida amanhã, o que seria?\n4. Quando foi a última vez que fizeste algo SÓ para ti?\n5. Se o teu corpo pudesse falar, o que diria?',
    cta: 'Responde nos comentários ou guarda para reflectir. A tua primeira reacção é a mais honesta.',
    audioScript: 'Estas 5 perguntas revelam mais sobre ti do que qualquer teste de personalidade. Primeira: quando estás em stress, o que fazes primeiro? Comes? Isolaste? Trabalhas mais? Ficas no telemóvel? A tua resposta automática revela o teu padrão. Segunda: o que evitas há mais de 6 meses? Aquilo que adias é o que mais precisa de atenção. Terceira: se pudesses mudar uma coisa amanhã, o que seria? A primeira resposta que te vem à cabeça é a mais honesta. Quarta: quando foi a última vez que fizeste algo só para ti? Se demoras a responder, é um sinal. Quinta: se o teu corpo pudesse falar, o que diria? Responde nos comentários. A tua primeira reacção é a mais verdadeira.',
    instagram: { caption: 'Estas 5 perguntas revelam mais do que qualquer teste.\n\nResponde nos comentários — qual te tocou mais?\n\n— Vivianne\n\n#autoconhecimento #reflexão #saúdemental #perguntas #bemestar #seteecos' },
    facebook: '5 perguntas que revelam mais sobre ti do que qualquer teste:\n\n1. Em stress, o que fazes PRIMEIRO?\n2. O que evitas há mais de 6 meses?\n3. Que coisa mudarias amanhã?\n4. Quando fizeste algo SÓ para ti?\n5. Se o teu corpo falasse, o que diria?\n\nResponde — qual te tocou mais?\n\n— Vivianne',
    whatsapp: '5 perguntas que te revelam mais do que qualquer teste:\n\n1. Em stress, o que fazes primeiro?\n2. O que evitas há 6 meses?\n3. Que coisa mudarias amanhã?\n4. Quando fizeste algo só para ti?\n5. Se o corpo falasse, o que diria?\n\nA primeira reacção é a mais honesta.',
    tiktok: { ideia: 'CARROSSEL com áudio. Cada pergunta num slide. Pausa entre slides. Voiceover reflexiva. Música trending calma.', caption: 'Estas 5 perguntas... #autoconhecimento #reflexão #saúdemental #fyp' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: '5 perguntas que te revelam',
      texto: 'Melhor que qualquer teste.',
      subtitulo: 'Responde nos comentários.',
      caption: '',
      slides: [
        { titulo: '5 perguntas que revelam mais sobre ti do que qualquer teste', texto: 'A tua primeira reacção é a mais honesta. Desliza →' },
        { titulo: '1. Em stress, o que fazes PRIMEIRO?', texto: 'Comes? Isolaste? Trabalhas mais? Ficas no telemóvel?\n\nA tua resposta automática revela o teu padrão de regulação emocional.' },
        { titulo: '2. O que evitas há mais de 6 meses?', texto: 'Aquilo que adias repetidamente é aquilo que mais precisa de atenção. Não é procrastinação — é protecção.' },
        { titulo: '3. Se pudesses mudar UMA coisa amanhã?', texto: 'A primeira resposta que te vem à cabeça é a mais honesta. Não a edites.' },
        { titulo: '4. Quando foi a última vez que fizeste algo SÓ para ti?', texto: 'Se demoras a responder, esse é o teu sinal.' },
        { titulo: '5. Se o teu corpo pudesse falar, o que diria?', texto: 'Responde nos comentários.\nA tua primeira reacção é a mais verdadeira.\n\nGuarda para reflectir.' },
      ],
    },
    dica: 'CARROSSEL 100% educativo + interactivo. Zero produto. Perguntas de auto-reflexão. Objectivo: COMENTÁRIOS + SAVES.',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'Corpo & Emoção — Educação',
    audioSlug: 'mkt-lz-10-olhar-dentro',
    titulo: 'Porque é que olhar para dentro muda o que está fora',
    eco: 'seteEcos',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL educativo profundo — publica entre 11h-13h. A GRANDE LIÇÃO do sistema. Objectivo: SHARES.',
    hook: 'Queres mudar a tua vida? Para de olhar para fora.',
    corpo: 'Comes mal? Não é problema de comida — é problema de emoção.\nAceitas o que não devias? Não é problema de coragem — é problema de valor próprio.\nEstás exausta? Não é problema de sono — é problema de limites.\nRepetes padrões? Não é azar — é falta de consciência.\n\nTodas as decisões externas são filtradas pelo estado interno.\nQuem não se conhece, é vivido pelo ambiente.\nQuem se conhece, navega o ambiente.',
    cta: 'Guarda. Lê outra vez. E envia a quem anda a tentar resolver fora o que está dentro.',
    audioScript: 'Queres mudar a tua vida? Para de olhar para fora. Comes mal? Não é problema de comida. É problema de emoção. Aceitas o que não devias? Não é falta de coragem. É falta de valor próprio. Estás exausta? Não é falta de sono. É falta de limites. Repetes os mesmos padrões? Não é azar. É falta de consciência. Todas as decisões externas são filtradas pelo teu estado interno. Se por dentro estás em caos, por fora reflectes caos. Quem não se conhece, é vivido pelo ambiente. Quem se conhece, navega o ambiente. Guarda isto. Lê outra vez.',
    instagram: { caption: 'Quem não se conhece, é vivido pelo ambiente.\nQuem se conhece, navega o ambiente.\n\nGuarda. Lê outra vez.\n\n— Vivianne\n\n#autoconhecimento #saúdemental #crescimentopessoal #consciência #reflexão #educação #seteecos' },
    facebook: 'Queres mudar a tua vida? Para de olhar para fora.\n\nComes mal → problema de emoção, não de comida\nAceitas o que não devias → problema de valor, não de coragem\nEstás exausta → problema de limites, não de sono\nRepetes padrões → falta de consciência, não azar\n\nQuem não se conhece, é vivido pelo ambiente.\n\n— Vivianne',
    whatsapp: 'Queres mudar a vida? Para de olhar para fora.\n\n• Comes mal → emoção\n• Aceitas demais → valor próprio\n• Exausta → limites\n• Repetes padrões → consciência\n\nQuem não se conhece, é vivido pelo ambiente.\n\nGuarda.',
    tiktok: { ideia: 'REEL 60s — Cada conexão "externo → interno" aparece uma de cada vez. Fundo escuro. Texto branco grande. Voiceover profunda. Finaliza com frase-âncora.', caption: 'Para de olhar para fora. #autoconhecimento #consciência #saúdemental #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'Para de olhar para fora.', subtitulo: 'Quem não se conhece, é vivido pelo ambiente.', caption: '' },
    dica: 'REEL EDUCATIVO — o post mais importante da campanha. Ensina a conexão interno→externo. Zero produto. Frase-âncora no final. Objectivo: máximo SHARES.',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'Corpo & Emoção — Educação',
    audioSlug: 'mkt-lz-11-4-ciclos',
    titulo: 'Os 4 padrões que a maioria das pessoas repete sem saber',
    eco: 'seteEcos',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL educativo — publica entre 18h-20h. Ensina padrões inconscientes. Objectivo: SAVES + comentários.',
    hook: 'Repetes isto sem saber. E é por isso que nada muda.',
    corpo: 'Ciclo da culpa alimentar: comes → culpa → restringes → compulsão → comes mais.\nCiclo do esgotamento: dás tudo → esgotamento → paras → culpa → voltas a dar tudo.\nCiclo do silêncio: engoles → acumulas → explodes → arrependes → engoles.\nCiclo da ocupação: ocupas-te → evitas sentir → cansas → compensas → ocupas-te.',
    cta: 'Reconheces algum? Guarda. O primeiro passo para quebrar um ciclo é vê-lo.',
    audioScript: 'Repetes isto sem saber. E é por isso que nada muda. Ciclo da culpa alimentar: comes, sentes culpa, restringes, dá-te compulsão, comes mais. Repete. Ciclo do esgotamento: dás tudo, esgotaste, paras, sentes culpa, voltas a dar tudo. Repete. Ciclo do silêncio: engoles o que queres dizer, acumulas, explodes, arrependeste, engoles outra vez. Repete. Ciclo da ocupação: ocupaste para não sentir, cansaste, compensas com comida ou ecrã, ocupaste outra vez. Repete. O primeiro passo para quebrar um ciclo é vê-lo. Se reconheces algum, guarda.',
    instagram: { caption: 'Repetes isto sem saber. E é por isso que nada muda.\n\nO primeiro passo para quebrar um ciclo é vê-lo.\n\nReconheces algum? Comenta.\n\n— Vivianne\n\n#ciclos #padrões #autoconhecimento #saúdemental #psicologia #educação #seteecos' },
    facebook: '4 ciclos que a maioria repete sem saber:\n\n1. Culpa alimentar: comes → culpa → restringes → compulsão → comes mais\n2. Esgotamento: dás tudo → esgotamento → paras → culpa → dás tudo\n3. Silêncio: engoles → acumulas → explodes → arrependes → engoles\n4. Ocupação: ocupaste → evitas sentir → cansas → compensas → ocupaste\n\nReconheces algum? O primeiro passo é ver.\n\n— Vivianne',
    whatsapp: '4 ciclos que repetes sem saber:\n\n1. Culpa alimentar\n2. Esgotamento\n3. Silêncio\n4. Ocupação\n\nO primeiro passo para quebrar é VER.\n\nGuarda.',
    tiktok: { ideia: 'CARROSSEL com áudio. Cada ciclo num slide circular (visual de loop). Voiceover pausada. Final: "O primeiro passo é ver."', caption: 'Repetes sem saber. #ciclos #padrões #autoconhecimento #fyp' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: '4 ciclos que repetes sem saber',
      texto: 'É por isso que nada muda.',
      subtitulo: 'O primeiro passo é ver.',
      caption: '',
      slides: [
        { titulo: 'Repetes isto sem saber.', texto: 'É por isso que nada muda. Desliza →' },
        { titulo: 'Ciclo da culpa alimentar', texto: 'Comes → culpa → restringes → compulsão → comes mais.\n\nRepete-se há meses. Talvez anos. Não é falta de disciplina. É um padrão.' },
        { titulo: 'Ciclo do esgotamento', texto: 'Dás tudo → esgotaste → paras → culpa → voltas a dar tudo.\n\nE chamas-lhe "ser responsável".' },
        { titulo: 'Ciclo do silêncio', texto: 'Engoles → acumulas → explodes → arrependeste → engoles.\n\nE chamas-lhe "manter a paz".' },
        { titulo: 'Ciclo da ocupação', texto: 'Ocupaste → evitas sentir → cansaste → compensas → ocupaste.\n\nE chamas-lhe "ser produtiva".' },
        { titulo: 'O primeiro passo para quebrar um ciclo é VÊ-LO.', texto: 'Reconheces algum?\n\nGuarda. Comenta qual é o teu.\n\nO autoconhecimento começa aqui.' },
      ],
    },
    dica: 'CARROSSEL 100% educativo. 6 slides. Ensina 4 ciclos inconscientes. Objectivo: COMENTÁRIOS ("qual é o teu?") + SAVES. Zero produto.',
  },

  // =================================================================
  // SEMANA 3: AS 7 DIMENSÕES — Educação por tema (Posts 12-17)
  // Objectivo: ensinar PORQUE cada dimensão importa na vida prática
  // Produto mencionado APENAS no último slide como ferramenta natural
  // =================================================================

  {
    dia: 12,
    fase: 3,
    audioSlug: 'mkt-lz-12-valor-proprio',
    faseTitulo: 'As 7 Dimensões — Educação',
    titulo: 'O que ninguém te ensinou sobre valor próprio',
    eco: 'aurea',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL educativo — publica de manhã (9h). Cor DOURADA. Ensina psicologia do valor próprio. Objectivo: SAVES + SHARES.',
    hook: 'Sabes quanto vales? Ou sabes quanto te disseram que vales?',
    corpo: 'A maioria das pessoas confunde valor próprio com autoestima.\n\nAutoestima é como te sentes sobre ti.\nValor próprio é o que acreditas que mereces.\n\nSe acreditas que não mereces, nem a melhor oportunidade te salva.\nPorque vais sabotá-la. Inconscientemente.',
    cta: 'Guarda. Isto explica muita coisa.',
    audioScript: 'Sabes quanto vales? Ou sabes quanto te disseram que vales? A maioria confunde autoestima com valor próprio. Autoestima é como te sentes sobre ti. Valor próprio é o que acreditas que mereces. Se cresceste a ouvir que não és suficiente, o teu cérebro gravou isso como verdade. E agora? Sabotás oportunidades. Aceitas menos do que mereces. Dás tudo aos outros e nada a ti. Não por escolha. Por programação. A boa notícia? Programação muda-se. Não com afirmações no espelho. Com acções concretas. Pequenas. Diárias. Guarda isto.',
    instagram: { caption: 'Sabes quanto vales? Ou sabes quanto te disseram que vales?\n\nAutoestima ≠ valor próprio.\n\nGuarda — isto explica muita coisa.\n\n— Vivianne\n\n#valorpróprio #autoestima #psicologia #autoconhecimento #educação #saúdemental #bemestar' },
    facebook: 'Sabes quanto vales? Ou sabes quanto te disseram que vales?\n\nAutoestima = como te sentes sobre ti\nValor próprio = o que acreditas que mereces\n\nSe cresceste a ouvir que não és suficiente, o cérebro gravou como verdade. E agora sabotás sem saber.\n\nA boa notícia? Programação muda-se.\n\n— Vivianne',
    whatsapp: 'Sabes quanto vales? Ou sabes quanto te disseram que vales?\n\nAutoestima ≠ valor próprio.\n\nSe cresceste a ouvir que não és suficiente, o cérebro gravou como verdade.\n\nMas programação muda-se. Guarda.',
    tiktok: { ideia: 'CARROSSEL dourado. Tom educativo. Cada slide distingue autoestima vs valor próprio com exemplos. Voiceover calma.', caption: 'Autoestima ≠ valor próprio. #valorpróprio #autoestima #psicologia #fyp' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'Valor próprio: o que ninguém ensina',
      texto: 'Sabes quanto vales?',
      subtitulo: 'Ou sabes quanto te disseram que vales?',
      caption: '',
      slides: [
        { titulo: 'Sabes quanto vales?', texto: 'Ou sabes quanto te DISSERAM que vales? Desliza →' },
        { titulo: 'Autoestima ≠ Valor próprio', texto: 'Autoestima = como te sentes sobre ti.\nValor próprio = o que acreditas que MERECES.\n\nSão coisas diferentes.' },
        { titulo: 'Se cresceste a ouvir "não és suficiente"...', texto: 'O teu cérebro gravou isso como verdade. E agora opera a partir dessa crença. Inconscientemente.' },
        { titulo: 'É por isso que sabotás.', texto: 'Recusas elogios. Aceitas menos. Dás tudo aos outros. Sentes culpa quando gastas em ti. Não é defeito. É programação.' },
        { titulo: 'A boa notícia?', texto: 'Programação muda-se. Não com afirmações no espelho. Com acções concretas. Pequenas. Diárias. Consistentes.' },
        { titulo: 'Exemplo prático:', texto: 'Esta semana, gasta 5 minutos a fazer algo SÓ para ti. Sem culpa. Sem justificação.\n\nGuarda. Envia a quem precisa.' },
      ],
    },
    dica: 'CARROSSEL educativo. Cor DOURADA (#C9A227). 6 slides. Ensina psicologia do valor próprio vs autoestima. Zero venda. Objectivo: SAVES.',
  },

  {
    dia: 13,
    fase: 3,
    audioSlug: 'mkt-lz-13-reprimir-emocoes',
    faseTitulo: 'As 7 Dimensões — Educação',
    titulo: 'Porque é que reprimir emoções te adoece',
    eco: 'serena',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL educativo — publica entre 18h-20h. Cor AZUL. Ensina impacto de reprimir emoções. Objectivo: SHARES.',
    hook: '"Sou forte" é a frase mais perigosa que podes dizer.',
    corpo: 'A ciência mostra: reprimir emoções aumenta cortisol, inflama o corpo, enfraquece o sistema imunitário.\n\nNão é teoria. É biologia.\n\nChoras no banho e sorris no dia seguinte? O corpo paga essa conta.\n\nSentir não é fraqueza. É a forma mais inteligente de proteger a tua saúde.',
    cta: 'Guarda. Envia a quem diz "sou forte" enquanto se destrói por dentro.',
    audioScript: 'Sou forte. É a frase mais perigosa que podes dizer. A ciência mostra: reprimir emoções aumenta o cortisol. Inflama o corpo. Enfraquece o sistema imunitário. Não é teoria. É biologia. Choras no banho e sorris no dia seguinte. O corpo paga essa conta. Engoles a raiva. Ignoras a tristeza. Finges que está tudo bem. Mas o corpo sabe. A insónia sabe. A tensão sabe. Sentir não é fraqueza. É a forma mais inteligente de proteger a tua saúde. Guarda. Envia a quem diz sou forte enquanto se destrói por dentro.',
    instagram: { caption: '"Sou forte" é a frase mais perigosa.\n\nReprimir emoções inflama o corpo. É ciência.\n\nSentir não é fraqueza. É inteligência.\n\nGuarda.\n\n— Vivianne\n\n#emoções #saúdemental #cortisol #ciência #sentir #bemestar #autoconhecimento' },
    facebook: '"Sou forte" — a frase mais perigosa que podes dizer.\n\nA ciência mostra que reprimir emoções:\n• Aumenta cortisol\n• Inflama o corpo\n• Enfraquece imunidade\n\nSentir não é fraqueza. É a forma mais inteligente de proteger a saúde.\n\n— Vivianne',
    whatsapp: '"Sou forte" — a frase mais perigosa.\n\nReprimir emoções aumenta cortisol e inflama o corpo.\n\nSentir não é fraqueza. É inteligência.\n\nGuarda.',
    tiktok: { ideia: 'REEL 60s — Texto em ecrã azul. Factos científicos sobre cortisol e repressão emocional. Voiceover calma. Música trending suave.', caption: '"Sou forte" é a frase mais perigosa. #emoções #saúdemental #ciência #fyp' },
    conteudoIG: { tipo: 'dica', texto: '"Sou forte" — a frase mais perigosa.', subtitulo: 'Sentir não é fraqueza. É ciência.', caption: '' },
    dica: 'REEL educativo. Fundo AZUL (#6B8E9B). Ensina biologia da repressão emocional. Zero produto. Objectivo: SHARES.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'As 7 Dimensões — Educação',
    audioSlug: 'mkt-lz-14-ocupada-vs-focada',
    titulo: 'A diferença entre estar ocupada e estar a avançar',
    eco: 'ignis',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL educativo — publica de manhã (9h). Cor TERRACOTA. Ensina foco consciente. Objectivo: SAVES.',
    hook: 'Há uma diferença entre estar ocupada e estar a avançar.',
    corpo: 'Ocupação é reactiva. Respondes ao que aparece.\nFoco é intencional. Proteges o que importa.\n\nA ocupação dá-te a ilusão de produtividade.\nO foco dá-te resultados reais.\n\nA pergunta não é "o que fiz hoje?" É "o que avancei hoje?"',
    cta: 'Guarda. E amanhã, antes de começar o dia, pergunta: o que PRECISO proteger hoje?',
    audioScript: 'Há uma diferença entre estar ocupada e estar a avançar. Ocupação é reactiva. Respondes ao que aparece. Mensagens. Fogos. Pedidos. O dia controla-te. Foco é intencional. Proteges o que importa. Escolhes. Priorizas. Dizes não. A ocupação dá-te a ilusão de produtividade. O foco dá-te resultados reais. A pergunta não é: o que fiz hoje? É: o que avancei hoje? Exercício prático: amanhã, antes de começar o dia, pergunta-te: o que preciso proteger hoje? Guarda.',
    instagram: { caption: 'Ocupada ≠ a avançar.\n\nOcupação é reactiva. Foco é intencional.\n\nA pergunta certa: "O que avancei hoje?"\n\nGuarda.\n\n— Vivianne\n\n#foco #produtividade #intencionalidade #crescimentopessoal #educação #bemestar' },
    facebook: 'Ocupada ≠ a avançar.\n\nOcupação é reactiva — respondes ao que aparece.\nFoco é intencional — proteges o que importa.\n\nAmanhã pergunta-te: o que preciso PROTEGER hoje?\n\n— Vivianne',
    whatsapp: 'Ocupada ≠ a avançar.\n\nOcupação: respondes ao que aparece.\nFoco: proteges o que importa.\n\nAmanhã pergunta: o que preciso proteger hoje?\n\nGuarda.',
    tiktok: { ideia: 'CARROSSEL terracota. Lado a lado: "Ocupada" vs "Focada" com exemplos práticos. Voiceover directa.', caption: 'Ocupada ≠ a avançar. #foco #produtividade #intencionalidade #fyp' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'Ocupada vs a avançar',
      texto: 'Há uma diferença.',
      subtitulo: 'E muda tudo.',
      caption: '',
      slides: [
        { titulo: 'Estás ocupada ou estás a avançar?', texto: 'Há uma diferença. E muda tudo. Desliza →' },
        { titulo: 'Ocupação é REACTIVA.', texto: 'Respondes a mensagens. Apagas fogos. Atendes pedidos. O dia controla-te. Sentes-te produtiva. Mas avançaste em quê?' },
        { titulo: 'Foco é INTENCIONAL.', texto: 'Escolhes o que importa. Proteges isso. Dizes não ao resto. Parece menos. Mas avança mais.' },
        { titulo: 'Ocupação = ilusão de produtividade.', texto: '12 horas "a trabalhar" e nada do que importa avançou. A ocupação é o refúgio de quem tem medo de parar e escolher.' },
        { titulo: 'A pergunta certa:', texto: 'Não é "o que fiz hoje?"\nÉ "o que AVANCEI hoje?"\n\nExercício: amanhã, antes de começar, pergunta:\n"O que preciso PROTEGER hoje?"' },
        { titulo: 'Experimenta. Guarda.', texto: 'Uma pergunta por dia muda mais do que uma lista de 20 tarefas.\n\nEnvia a quem vive a correr sem avançar.' },
      ],
    },
    dica: 'CARROSSEL educativo. Cor TERRACOTA (#C1634A). 6 slides. Ensina diferença entre ocupação e foco. Exercício prático. Zero produto.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'As 7 Dimensões — Educação',
    audioSlug: 'mkt-lz-15-cansaco-cronico',
    titulo: 'O que o cansaço crónico te está a dizer',
    eco: 'ventis',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL educativo — publica entre 12h-14h. Cor TEAL. Ensina sobre energia e ritmo circadiano. Objectivo: SHARES.',
    hook: 'Se precisas de 3 cafés para funcionar, o problema não é sono.',
    corpo: 'O teu corpo tem um ritmo natural — chama-se ritmo circadiano.\n\nPicos de energia de manhã. Baixa natural a meio da tarde. Recuperação à noite.\n\nQuando ignoras esse ritmo, forças o corpo. E o corpo cobra.\n\nNão é mais café que precisas. É respeitar o teu ritmo.',
    cta: 'Guarda. Amanhã, observa: a que horas tens mais energia natural?',
    audioScript: 'Se precisas de 3 cafés para funcionar, o problema não é sono. O teu corpo tem um ritmo natural. Chama-se ritmo circadiano. Picos de energia de manhã. Baixa natural a meio da tarde. Recuperação à noite. A maioria das pessoas trabalha CONTRA este ritmo. Força produtividade quando o corpo pede pausa. Descansa quando o corpo tem energia. E depois compensa com café, açúcar, ecrãs. Não é mais café que precisas. É respeitar o teu ritmo. Exercício: amanhã, observa — a que horas tens mais energia natural? Guarda.',
    instagram: { caption: '3 cafés para funcionar? O problema não é sono.\n\nÉ ignorar o teu ritmo circadiano.\n\nAmanhã observa: a que horas tens mais energia?\n\nGuarda.\n\n— Vivianne\n\n#energia #cansaço #ritmocircadiano #ciência #saúde #bemestar #autoconhecimento' },
    facebook: '3 cafés e ainda te arrastas?\n\nO problema não é sono. É ignorar o teu ritmo circadiano.\n\nPicos de manhã. Baixa à tarde. Recuperação à noite.\n\nQuando trabalhas contra este ritmo, o corpo cobra.\n\nAmanhã observa: a que horas tens mais energia?\n\n— Vivianne',
    whatsapp: '3 cafés e arrastas-te?\n\nNão é sono. É ritmo circadiano.\n\nAmanhã observa: a que horas tens mais energia natural?\n\nGuarda.',
    tiktok: { ideia: 'REEL 60s — Gráfico simples do ritmo circadiano. Voiceover explica picos e baixas. Dica prática no final.', caption: '3 cafés? O problema não é sono. #energia #cansaço #ciência #fyp' },
    conteudoIG: { tipo: 'dica', texto: '3 cafés para funcionar?', subtitulo: 'O problema não é sono. É ritmo.', caption: '' },
    dica: 'REEL educativo. Fundo TEAL (#5D9B84). Ensina ritmo circadiano de forma simples. Exercício prático. Zero produto.',
  },

  {
    dia: 16,
    fase: 3,
    audioSlug: 'mkt-lz-16-preco-silencio',
    faseTitulo: 'As 7 Dimensões — Educação',
    titulo: 'O preço de ficar em silêncio',
    eco: 'ecoa',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL educativo — publica entre 18h-20h. Cor AZUL OCEANO. Ensina impacto do silenciamento. Objectivo: SAVES + SHARES.',
    hook: 'Cada vez que engoles o que querias dizer, o corpo guarda.',
    corpo: 'O silêncio tem um preço:\n\nFísico: tensão no pescoço, dor de cabeça, bruxismo.\nEmocional: ressentimento, raiva contida, explosões.\nRelacional: distância, mal-entendidos, solidão.\n\nNão é "manter a paz". É pagar um preço silencioso por uma paz que não existe.',
    cta: 'Guarda. Pensa na última vez que engoliste algo. O que custou?',
    audioScript: 'Cada vez que engoles o que querias dizer, o corpo guarda. O silêncio tem um preço. Físico: tensão no pescoço. Dor de cabeça. Bruxismo. Emocional: ressentimento. Raiva contida. Explosões inesperadas. Relacional: distância. Mal-entendidos. Solidão. Não é manter a paz. É pagar um preço silencioso por uma paz que não existe. Pensa na última vez que engoliste algo. O que custou? Guarda. Envia a quem precisa.',
    instagram: { caption: 'O silêncio tem um preço.\n\nFísico. Emocional. Relacional.\n\nNão é "manter a paz". É pagar por uma paz que não existe.\n\nGuarda.\n\n— Vivianne\n\n#voz #expressão #comunicação #silêncio #saúdemental #autoconhecimento #bemestar' },
    facebook: 'O silêncio tem um preço:\n\nFísico: tensão, dor de cabeça, bruxismo\nEmocional: ressentimento, raiva, explosões\nRelacional: distância, solidão\n\nNão é "manter a paz". É pagar por uma paz que não existe.\n\n— Vivianne',
    whatsapp: 'O silêncio tem um preço:\n\n• Físico: tensão, bruxismo\n• Emocional: raiva contida\n• Relacional: distância\n\nNão é manter a paz. É pagar por uma paz que não existe.\n\nGuarda.',
    tiktok: { ideia: 'CARROSSEL azul oceano. Três categorias de preço (físico/emocional/relacional). Voiceover pausada. Objectivo: shares.', caption: 'O silêncio tem um preço. #voz #silêncio #comunicação #fyp' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'O preço de ficar em silêncio',
      texto: 'Cada vez que engoles, o corpo guarda.',
      subtitulo: 'Não é paz. É um preço.',
      caption: '',
      slides: [
        { titulo: 'O silêncio tem um preço.', texto: 'E não é o que pensas. Desliza →' },
        { titulo: 'Preço FÍSICO', texto: 'Tensão no pescoço. Dor de cabeça crónica. Bruxismo. Insónia.\n\nO corpo guarda o que a boca não diz.' },
        { titulo: 'Preço EMOCIONAL', texto: 'Ressentimento que cresce. Raiva contida que explode nos momentos errados. Tristeza que não tem nome.' },
        { titulo: 'Preço RELACIONAL', texto: 'Distância de quem amas. Mal-entendidos que podiam ser evitados. Solidão no meio de gente.' },
        { titulo: 'Não é "manter a paz".', texto: 'É pagar um preço silencioso por uma paz que não existe.\n\nA verdadeira paz vem de dizer o que precisas. Com respeito. Com clareza.' },
        { titulo: 'Exercício:', texto: 'Pensa na última vez que engoliste algo.\nO que te custou?\n\nGuarda. Envia a quem precisa.' },
      ],
    },
    dica: 'CARROSSEL educativo. Cor AZUL OCEANO (#4A90A4). 6 slides. Ensina 3 custos do silenciamento. Exercício reflexivo. Zero produto.',
  },

  {
    dia: 17,
    fase: 3,
    audioSlug: 'mkt-lz-17-integracao',
    faseTitulo: 'As 7 Dimensões — Educação',
    titulo: 'Porque precisas de integração, não de mais informação',
    eco: 'lumina',
    template: 'cta',
    formato: 'reel',
    cronograma: 'REEL de síntese — publica entre 11h-13h. Resume toda a aprendizagem. Único post com CTA directa.',
    hook: 'Já sabes muito. Comes e mesmo assim não funciona. Lês e mesmo assim repetes. Porquê?',
    corpo: 'Porque a informação está fragmentada.\n\nSabes de nutrição. Mas não sabes que comes por emoção.\nSabes de produtividade. Mas não sabes que a ocupação é fuga.\nSabes de comunicação. Mas não sabes por que te calas.\n\nO conhecimento isolado não transforma. A integração sim.\n\nNas últimas semanas partilhei o que aprendi. Agora convido-te a descobrir o teu ponto de partida.',
    cta: 'Diagnóstico grátis. 2 minutos. 23 leituras possíveis: app.seteecos.com/lumina',
    audioScript: 'Já sabes muito. Comes bem e mesmo assim não funciona. Lês sobre produtividade e mesmo assim repetes padrões. Porquê? Porque a informação está fragmentada. Sabes de nutrição. Mas não sabes que comes por emoção. Sabes de produtividade. Mas não sabes que a ocupação é fuga. Sabes de comunicação. Mas não sabes por que te calas. O conhecimento isolado não transforma. A integração sim. Corpo. Valor. Emoção. Foco. Energia. Voz. Identidade. 7 dimensões que precisam de conversar. Nas últimas semanas partilhei o que aprendi. Agora convido-te a descobrir o teu ponto de partida. Diagnóstico grátis. 2 minutos. Link na bio.',
    instagram: { caption: 'Já sabes muito. Mas saberes isolados não transformam.\n\nÉ a integração que muda.\n\nDescobre o teu ponto de partida — grátis, 2 min.\n\nLink na bio.\n\n— Vivianne\n\n#integração #autoconhecimento #transformação #grátis #educação #bemestar #seteecos' },
    facebook: 'Já sabes muito. Mas saberes isolados não transformam.\n\nSabes de nutrição — mas comes por emoção.\nSabes de produtividade — mas a ocupação é fuga.\nSabes de comunicação — mas calas-te.\n\nA integração é o que falta.\n\nDescobre o teu ponto de partida (grátis): app.seteecos.com/lumina\n\n— Vivianne',
    whatsapp: 'Já sabes muito. Mas saberes isolados não transformam.\n\nA integração é o que muda.\n\nDescobre o teu ponto de partida:\n👉 app.seteecos.com/lumina (grátis, 2 min)',
    tiktok: { ideia: 'REEL 60s — Cada "sabes de X mas Y" aparece como revelação. Transição de cores (cada eco). Final com CTA para Lumina.', caption: 'Já sabes muito. Mas isso basta? #integração #autoconhecimento #fyp #seteecos' },
    conteudoIG: { tipo: 'cta', texto: 'Já sabes muito. Mas basta?', subtitulo: 'Integração > informação.', caption: '' },
    dica: 'REEL de síntese final. ÚNICO post com CTA directa. Transição de cores dos 7 ecos. Voiceover ElevenLabs. Resume a aprendizagem das 3 semanas.',
  },
];
