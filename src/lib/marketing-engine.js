 ...
 * - Inteligência nutricional e desportiva: ciência acessível, comida real, sem restrição.
...
const CONTEUDO_CORPO = [
  {
    hook: 'A comida que a tua avó fazia é mais saudável que qualquer suplemento importado.',
    corpo: 'Ferro, vitaminas, proteína vegetal. Tudo na comida real que já conheces. Não precisas de comprar nada caro. Precisas de voltar ao que é teu.',
    cta: 'O VITALIS ensina-te a usar o que já tens.',
  },
  {
    hook: 'Hidratos não engordam. O que engorda é a falta de equilíbrio no prato.',
  ...
  {
    hook: 'Beber 2 litros de água por dia não é conselho. É sobrevivência.',
    corpo: 'O teu corpo perde mais água do que imaginas. A desidratação disfarça-se de fome. Antes de comer, bebe. Depois decide.',
  ...
  {
    hook: 'A proteína mais barata? Leguminosas, ovos e frutos secos.',
    corpo: 'Esquece suplementos caros. Feijão, grão, lentilhas, amendoim, ovo cozido. Comida real, acessível, nutritiva. A ciência confirma o que as avós já sabiam.',
    cta: 'Receitas com ingredientes que encontras em qualquer mercado.',
  },
  {
...
const LANCAMENTO_POSTS = [
  // =================================================================
  // FASE 1: MARCA & DESTAQUES (Posts 1-4)
  // Objectivo: Identidade visual do perfil + primeiros Reels
  // =================================================================

  {
    ...
    titulo: 'A pergunta que ninguém te faz',
    eco: 'lumina',
    template: 'dica',
    formato: 'reel',
    hook: 'Quando foi a última vez que alguém te perguntou "como te sentes de verdade?"',
    corpo: 'Não o que queres comer. Não quanto pesas. Como TE SENTES.\n\nA maioria de nós passa anos sem fazer esta pergunta a si mesma. Corremos entre o trabalho, a casa, os filhos — e esquecemos de nós.\n\nEste perfil nasceu para mudar isso.',
    cta: 'Segue para mais. Isto é só o começo.',
    instagram: { caption: 'Quando foi a última vez que alguém te perguntou "como te sentes de verdade?" 🤍\n\nNão o que queres comer. Não quanto pesas.\nComo TE SENTES.\n\nA maioria de nós passa anos sem fazer esta pergunta.\n\nEste perfil nasceu para mudar isso.\n\nSegue — isto é só o começo.\n\n#seteecos #bemestar #autoconhecimento #saúde #transformação #maputo #moçambique #reels' },
    facebook: 'Quando foi a última vez que alguém te perguntou "como te sentes de verdade?" 🤍\n\nNão o que queres comer. Não quanto pesas. Como TE SENTES.\n\nEste perfil nasceu para mudar isso.\n\n— Vivianne | Sete Ecos',
    whatsapp: 'Quando foi a última vez que alguém te perguntou "como te sentes de verdade?"\n\nCriei um espaço para isso. Segue @seteecos no Instagram.',
    tiktok: { ideia: 'REEL — TEXTO EM ECRÃ (palavra a palavra, fundo escuro, música calma trending):\n\n"Quando foi a última vez..."\n"...que alguém te perguntou..."\n"...como te sentes DE VERDADE?"\n\n[pausa 2s]\n\n"Este perfil nasceu para mudar isso."\n"Segue."', caption: 'Quando foi a última vez? 🤍 #seteecos #bemestar #fyp #autoconhecimento' },
    conteudoIG: { tipo: 'dica', texto: 'Quando foi a última vez que alguém te perguntou "como te sentes de verdade?"', subtitulo: 'Este perfil nasceu para mudar isso.', caption: '' },
    dica: 'REEL obrigatório — único formato que chega a quem não te segue. Texto animado + música trending calma. Sem cara, sem voz. Publica como Reel (NÃO como post estático — Reels têm 10x mais alcance com zero seguidores).',
  },

  {
    ...
    fase: 1,
    faseTitulo: 'Marca & Destaques',
    titulo: '7 dimensões. 1 sistema.',
    eco: 'lumina',
    template: 'dica',
    formato: 'reel',
    hook: 'Isto não é mais uma app de dieta. São 7 dimensões de transformação.',
    corpo: '🌿 Corpo (Vitalis)\n✨ Valor próprio (Áurea)\n💧 Emoção (Serena)\n🔥 Foco (Ignis)\n🍃 Energia (Ventis)\n🔊 Voz (Ecoa)\n⭐ Identidade (Imago)\n\nCada dimensão com a sua cor. O seu programa. A sua identidade.\n\nChama-se Sete Ecos.',
    cta: 'Nos próximos dias vais conhecer cada um. Segue.',
    instagram: { caption: 'Isto NÃO é mais uma app de dieta. 🙅\n\nSão 7 dimensões de transformação:\n\n🌿 Corpo (Vitalis)\n✨ Valor próprio (Áurea)\n💧 Emoção (Serena)\n🔥 Foco (Ignis)\n🍃 Energia (Ventis)\n🔊 Voz (Ecoa)\n⭐ Identidade (Imago)\n\nCada uma com a sua cor. O seu programa.\n\nChama-se Sete Ecos.\n\n#seteecos #transformação #bemestar #holístico #saúde #maputo #moçambique #reels' },
    facebook: 'Isto NÃO é mais uma app de dieta.\n\nSão 7 dimensões de transformação:\nCorpo • Valor • Emoção • Foco • Energia • Voz • Identidade\n\nChama-se Sete Ecos.\n\n— Vivianne | Sete Ecos',
    whatsapp: 'Criei algo que não existe em Moçambique: um sistema com 7 dimensões de transformação.\n\nCorpo • Emoção • Energia • Foco • Voz • Identidade • Valor.\n\nChama-se Sete Ecos. Segue @seteecos no Instagram.',
    tiktok: { ideia: 'REEL — Revelação dramática (fundo escuro, cada eco aparece com a SUA cor):\n\n"Isto não é uma app de dieta."\n[pausa]\n"São 7 dimensões."\n[cada uma aparece com a sua cor de fundo]\n🌿 Corpo\n✨ Valor\n💧 Emoção\n🔥 Foco\n🍃 Energia\n🔊 Voz\n⭐ Identidade\n[pausa]\n"Chama-se Sete Ecos."', caption: '7 dimensões. 1 sistema. 🌿 #seteecos #fyp #transformação #bemestar' },
    conteudoIG: { tipo: 'dica', texto: 'Isto não é mais uma app de dieta.', subtitulo: '7 dimensões. 1 sistema. Sete Ecos.', caption: '' },
    dica: 'REEL com transição de cores — cada eco aparece com o SEU fundo colorido. Vitalis verde (#7C8B6F), Áurea dourado (#C9A227), Serena azul (#6B8E9B), Ignis terracota (#C1634A), Ventis teal (#5D9B84), Ecoa azul oceano (#4A90A4), Imago roxo (#8B7BA5). Efeito visual forte.',
  },

  {
    ...
    fase: 1,
    faseTitulo: 'Marca & Destaques',
    titulo: 'O diagnóstico que ninguém te fez',
    eco: 'lumina',
    template: 'cta',
    formato: 'reel',
    hook: '7 perguntas. 2 minutos. 23 leituras possíveis. E é grátis.',
    corpo: 'O LUMINA analisa 8 dimensões da tua vida: corpo, energia, mente, emoção, conexão e mais.\n\nNão é um quiz genérico. É uma leitura personalizada que revela padrões que não vias.\n\nE sim — é completamente gratuito.',
    cta: 'Experimenta: app.seteecos.com/lumina',
    instagram: { caption: '7 perguntas. 2 minutos. 23 leituras possíveis.\nE é grátis. 🔮\n\nO LUMINA é o primeiro passo do sistema Sete Ecos.\n\nAnalisa 8 dimensões da tua vida e revela padrões que não vias.\n\nNão é quiz genérico. É leitura personalizada.\n\n🔗 Link na bio\n\n#lumina #seteecos #diagnóstico #autoconhecimento #grátis #maputo #moçambique #reels' },
    facebook: '7 perguntas. 2 minutos. 23 leituras possíveis. E é grátis. 🔮\n\nO LUMINA revela padrões que não vias.\n\nExperimenta: app.seteecos.com/lumina\n\n— Vivianne | Sete Ecos',
    whatsapp: '7 perguntas. 2 minutos. 23 leituras possíveis. Grátis.\n\nQual vai ser a tua?\n\n👉 app.seteecos.com/lumina',
    tiktok: { ideia: 'REEL — SCREEN RECORDING do telemóvel:\n\nTexto antes: "Fiz este teste e fiquei de boca aberta 😳"\n\n[gravar ecrã a abrir app.seteecos.com/lumina]\n[mostrar as perguntas]\n[mostrar o resultado]\n\nTexto depois: "É grátis. Link na bio."', caption: 'Fiz este teste grátis e... 😳 #seteecos #lumina #teste #fyp' },
    conteudoIG: { tipo: 'cta', texto: '7 perguntas. 2 minutos. 23 leituras. Grátis.', subtitulo: 'LUMINA — o diagnóstico que revela o que não vias.', caption: '' },
    dica: 'REEL — Screen recording do Lumina no telemóvel. Grava o ecrã a fazer o teste e mostrar o resultado. É o formato mais autêntico e funciona muito bem. Alternativa: texto animado com contagem regressiva "7... 6... 5...".',
  },
...

  {
    ...
    titulo: 'Fiz o teste e fiquei de boca aberta',
    eco: 'lumina',
    template: 'dica',
    formato: 'reel',
    hook: 'Fiz um teste de 2 minutos e descobri coisas sobre mim que não sabia.',
    corpo: 'O LUMINA faz-te 7 perguntas simples. Mas as respostas revelam padrões que não vias.\n\nEnergia baixa? Pode ser desconexão emocional.\nTensão no corpo? Pode ser palavras engolidas.\nCansaço crónico? Pode ser falta de ritmo, não de sono.\n\n23 leituras possíveis. Qual é a tua?',
    cta: 'Grátis. 2 minutos. Link na bio.',
    instagram: { caption: 'Fiz um teste de 2 minutos e descobri coisas sobre mim que não sabia. 😳\n\nO LUMINA faz 7 perguntas simples. Mas as respostas revelam padrões escondidos:\n\nEnergia baixa? Pode ser desconexão emocional.\nTensão no corpo? Palavras engolidas.\nCansaço? Falta de ritmo, não de sono.\n\n23 leituras possíveis. Qual é a tua?\n\nGrátis 🔗 Link na bio\n\n#lumina #seteecos #diagnóstico #autoconhecimento #testegrátis #maputo #moçambique #reels' },
    facebook: 'Fiz um teste de 2 minutos e descobri coisas sobre mim que não sabia.\n\n23 leituras possíveis. Qual é a tua?\n\nGrátis → app.seteecos.com/lumina\n\n— Vivianne | Sete Ecos',
    whatsapp: 'Fiz um teste de 2 minutos e fiquei de boca aberta.\n\n23 leituras possíveis. Grátis.\n\nQual vai ser a tua?\n👉 app.seteecos.com/lumina',
    tiktok: { ideia: 'REEL — POV:\n\n"POV: Fazes um teste de 2 minutos e descobres coisas sobre ti que não sabias"\n\n[screen recording do Lumina]\n[mostrar resultado surpreendente]\n\n"23 leituras possíveis. Grátis. Link na bio."', caption: 'POV: descobres a verdade sobre ti 😳 #lumina #seteecos #fyp #teste' },
    conteudoIG: { tipo: 'dica', texto: 'Fiz um teste de 2 minutos.', subtitulo: 'E descobri coisas sobre mim que não sabia.', caption: '' },
    dica: 'REEL — POV format (muito popular). Screen recording do Lumina se possível, ou texto animado com revelação. O hook "fiz e fiquei de boca aberta" gera curiosidade.',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'Lumina + Vitalis',
    titulo: 'Saúde real. Feita para ti.',
    eco: 'vitalis',
    template: 'dica',
    formato: 'reel',
    mockups: ['/mockups/mozproud-vitalis.jpeg'],
    hook: 'Não é mais um app de dieta genérico. É inteligência nutricional real.',
    corpo: 'O VITALIS é uma plataforma inteira de saúde personalizada.\n\n98 receitas equilibradas. Coach disponível 24h. Treinos adaptados ao teu ciclo. Espaço para quando a emoção pesa mais que a fome.\n\nFeita em Moçambique. Para ti.',
    cta: '7 dias grátis. Link na bio.',
    instagram: { caption: 'Saúde real. Feita para ti. 🌿\n\nNão é mais um app de dieta genérico.\nÉ inteligência nutricional e desportiva. Personalizada. Com ciência.\n\n🍽 98 receitas equilibradas\n📱 Coach disponível 24h\n💪 Treinos adaptados ao teu ciclo\n💜 Espaço para quando a emoção pesa\n\nFeita em Moçambique.\n\n7 dias grátis → link na bio\n\n#vitalis #seteecos #saudereal #nutricao #coachingnutricional #maputo #moçambique #reels' },
    facebook: 'Saúde real. Feita para ti. 🌿\n\nNão é dieta. É coaching nutricional com ciência e emoção.\n\n7 dias grátis → app.seteecos.com/vitalis\n\n— Vivianne | VITALIS',
    whatsapp: '🌿 *VITALIS — Inteligência nutricional.*\n\n98 receitas. Coach 24h. Treinos. Espaço emocional.\n\nNão é dieta. É cuidado.\n\n7 dias grátis 👉 app.seteecos.com/vitalis',
    tiktok: { ideia: 'REEL — Mostrar o mockup da app:\n\n"Saúde real. Feita para ti."\n[mostrar mockup mozproud-vitalis]\n"98 receitas. Coach 24h. Treinos."\n"Feita em Moçambique."\n"7 dias grátis — link na bio."', caption: 'Saúde real 🌿 #vitalis #seteecos #nutricao #fyp #moçambique' },
    conteudoIG: { tipo: 'dica', texto: 'Saúde real. Feita para ti.', subtitulo: 'VITALIS — inteligência nutricional.', caption: '' },
    dica: 'REEL com a imagem mockup mozproud-vitalis.jpeg como fundo. Texto animado por cima. Mostra que é um produto REAL e profissional. Fundo VERDE (#7C8B6F) — cor do Vitalis.',
  },

  {
    ...
    corpo: 'É uma app completa no teu telemóvel:\n\n📋 Plano personalizado\n✅ Check-in diário — água, sono, emoção\n🍽 Registo de refeições\n📖 98 receitas equilibradas\n💜 Espaço de Retorno emocional\n📊 Relatórios de evolução\n💪 Treinos adaptados',
    cta: 'Link na bio. Envia DM para saber mais.',
    instagram: { caption: 'Isto é o VITALIS por dentro. 📱\n\nNão é um PDF.\nNão é um grupo de WhatsApp.\n\nÉ uma app completa:\n\n📋 Plano personalizado\n✅ Check-in diário\n🍽 Refeições\n📖 98 receitas\n💜 Espaço emocional\n📊 Relatórios\n💪 Treinos\n\nTudo num só lugar.\n\nLink na bio 🌿\n\n#vitalis #seteecos #appsaude #dashboard #planoalimentar #maputo #moçambique #reels' },
    facebook: 'Isto é o VITALIS por dentro. 📱\n\nNão é PDF. Não é grupo de WhatsApp. É app completa.\n\nLink na bio.\n\n— Vivianne | VITALIS',
    whatsapp: '📱 *Já viste o VITALIS por dentro?*\n\n📋 Plano personalizado\n✅ Check-in diário\n📖 98 receitas\n💜 Espaço emocional\n📊 Relatórios\n💪 Treinos\n\nTudo no telemóvel 👉 app.seteecos.com/vitalis',
    tiktok: { ideia: 'REEL — Mostrar mockup do dashboard:\n\n"Isto é o VITALIS por dentro."\n[mostrar Vitalis-dashboard_mb-mockup]\n"Não é PDF. Não é WhatsApp."\n[listar funcionalidades uma a uma]\n"Link na bio."', caption: 'VITALIS por dentro 📱 #vitalis #seteecos #fyp #app' },
    conteudoIG: { tipo: 'dica', texto: 'Isto é o VITALIS por dentro.', subtitulo: 'Não é PDF. Não é grupo de WhatsApp.', caption: '' },
    dica: 'REEL com o mockup Vitalis-dashboard_mb-mockup.jpeg. Mostra que é real e profissional. Fundo VERDE (#7C8B6F). O mockup impressiona — usa-o.',
  },

  {
    ...
    corpo: 'A Coach Vivianne no VITALIS está disponível 24 horas. Sem julgamento. Sem espera.\n\nPergunta sobre porções. Monta o teu prato. Dúvidas sobre jejum. Adapta o treino.\n\nIsto não é chatbot genérico. É coaching nutricional REAL, sempre disponível.',
    cta: 'Link na bio.',
    instagram: { caption: '3 da manhã. A ansiedade aperta. Abres o frigorífico.\n\nE se em vez disso... abrires uma conversa? 🤍\n\nA Coach Vivianne no VITALIS:\n\n📱 Disponível 24h\n🤲 Porções certas\n🍽 Monta o prato\n⏰ Jejum\n💪 Treino\n\nSem julgamento. Sem espera.\n\nLink na bio 🌿\n\n#vitalis #seteecos #coach24h #coachingnutricional #maputo #moçambique #reels' },
    facebook: '3 da manhã. Ansiedade. E se em vez do frigorífico, abrires uma conversa?\n\nCoach disponível 24h. Sem julgamento.\n\n— Vivianne | VITALIS',
    whatsapp: '🤍 *Imagina uma coach de nutrição disponível às 3 da manhã.*\n\nSem julgamento. Sem espera.\n\nA Coach Vivianne responde-te SEMPRE.\n\n👉 app.seteecos.com/vitalis',
    tiktok: { ideia: 'REEL — Cenário emocional:\n\n"3 da manhã. Ansiedade."\n"Abres o frigorífico."\n[pausa]\n"E se em vez disso..."\n"...abrires uma conversa?"\n[mostrar mockup coach]\n"Coach 24h. Sem julgamento."\n"VITALIS — link na bio."', caption: 'Coach às 3 da manhã 🤍 #vitalis #seteecos #fyp #coaching' },
    conteudoIG: { tipo: 'dica', texto: '3 da manhã. Ansiedade. Frigorífico.', subtitulo: 'E se abrires uma conversa? Coach 24h.', caption: '' },
    dica: 'REEL com mockup Vitalis-coach_mb-mockup.jpeg. O cenário "3 da manhã + ansiedade + frigorífico" toca na dor REAL. Fundo VERDE (#7C8B6F).',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'Lumina + Vitalis',
    titulo: '98 receitas. Nenhuma pede quinoa.',
    eco: 'vitalis',
    template: 'dica',
    formato: 'reel',
    mockups: ['/mockups/Vitalis-receitas_mb-mockup.jpeg'],
    hook: '98 receitas e nenhuma te pede quinoa ou abacate importado.',
    corpo: 'Comida real. Equilibrada. Saborosa.\n\n🥘 Pratos tradicionais\n🥗 Opções leves\n🍲 Comfort food saudável\n🥙 Rápidas do dia-a-dia\n\nCada receita filtrada para o TEU perfil. Ingredientes que encontras em qualquer mercado.\n\nChega de dietas com comida que não existe na tua realidade.',
    cta: 'Link na bio.',
    instagram: { caption: '98 receitas. Nenhuma pede quinoa. 🍽\n\nComida real. Equilibrada. Saborosa.\n\n🥘 Pratos tradicionais\n🥗 Opções leves\n🍲 Comfort food\n🥙 Rápidas\n\nFiltradas para o TEU perfil.\nIngredientes do mercado.\n\nChega de dietas impossíveis.\n\nLink na bio 🌿\n\n#vitalis #seteecos #receitassaudaveis #comidadeverdade #maputo #moçambique #reels' },
    facebook: '98 receitas e nenhuma pede quinoa. 🍽\n\nComida real, equilibrada, com ingredientes do mercado.\n\n— Vivianne | VITALIS',
    whatsapp: '🍽 *98 receitas e NENHUMA pede quinoa.*\n\nComida real e acessível. Filtradas para o teu perfil.\n\nSem listas impossíveis.\n\n👉 app.seteecos.com/vitalis',
    tiktok: { ideia: 'REEL — Mostrar receitas:\n\n"98 receitas."\n"Nenhuma pede quinoa."\n[mostrar mockup receitas]\n"Comida REAL. Do mercado."\n"Filtradas para TI."\n"VITALIS — link na bio."', caption: 'Sem quinoa 🍽 #vitalis #seteecos #receitas #fyp #comidareal' },
    conteudoIG: { tipo: 'dica', texto: '98 receitas. Nenhuma pede quinoa.', subtitulo: 'Comida real. Do mercado. Para ti.', caption: '' },
    dica: 'REEL com mockup Vitalis-receitas_mb-mockup.jpeg. O argumento "comida real e acessível" é o mais forte — as pessoas estão fartas de dietas impossíveis. Fundo VERDE (#7C8B6F).',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'Lumina + Vitalis',
    titulo: 'O espaço para quando a emoção pesa.',
    eco: 'vitalis',
    template: 'dica',
    formato: 'reel',
    mockups: ['/mockups/Vitalis-espaçoretorno_mb-mockup.jpeg'],
    hook: 'O que estás a sentir agora? Cansaço. Ansiedade. Tristeza. Vazio.',
    corpo: 'Isto é o Espaço de Retorno do VITALIS. O lugar dentro da app onde não se fala de comida. Fala-se de TI.\n\nPorque 80% dos problemas com alimentação são emocionais. E nenhuma dieta resolve isso.\n\nAntes de mudar o que comes, precisas de entender PORQUE comes.',
    cta: 'Link na bio.',
    instagram: { caption: 'O que estás a sentir agora? 💜\n\nCansaço. Ansiedade. Tristeza. Vazio.\n\nIsto é o Espaço de Retorno do VITALIS.\n\nO lugar onde não se fala de comida. Fala-se de TI.\n\n80% dos problemas com alimentação são emocionais.\n\nAntes de mudar o que comes, entende PORQUE comes.\n\nLink na bio 🌿\n\n#vitalis #seteecos #saudeemocional #espacoseguro #maputo #moçambique #reels' },
    facebook: 'O que estás a sentir agora?\n\n80% dos problemas com alimentação são emocionais. E nenhuma dieta resolve isso.\n\n— Vivianne | VITALIS',
    whatsapp: '💜 *Antes de mudar o que comes, entende PORQUE comes.*\n\nO Espaço de Retorno no VITALIS: para quando a emoção pesa mais que a fome.\n\n👉 app.seteecos.com/vitalis',
    tiktok: { ideia: 'REEL — Emocional:\n\n"O que estás a sentir agora?"\n"Cansaço. Ansiedade. Tristeza."\n[pausa]\n"80% dos problemas com comida são emocionais."\n[mostrar mockup espaço retorno]\n"Este espaço existe para isso."\n"VITALIS — link na bio."', caption: 'Porque comes? 💜 #vitalis #seteecos #emocional #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'O que estás a sentir agora?', subtitulo: '80% dos problemas com comida são emocionais.', caption: '' },
    dica: 'REEL com mockup Vitalis-espaçoretorno_mb-mockup.jpeg. Este é o diferencial ÚNICO do VITALIS — nenhum app de nutrição tem espaço emocional. Fundo VERDE (#7C8B6F).',
  },
...

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'ÁUREA — O teu valor não cabe numa calça.',
    eco: 'aurea',
    template: 'dica',
    formato: 'reel',
    mockups: ['/mockups/Aurea-Dash-portrait.png', '/mockups/Aurea-praticas-portrait.png'],
    hook: 'O teu valor não cabe numa calça tamanho S.',
    corpo: 'Foram anos a ouvir que só mereces respeito se fores magra. Que só és bonita se a roupa for pequena.\n\nIsso é mentira.\n\nO ÁUREA trabalha o teu valor próprio:\n✨ 100+ micro-práticas\n✨ 4 áreas: dinheiro, tempo, roupa, prazer\n✨ Check-ins de espelho\n✨ Carteira do valor',
    cta: 'Link na bio.',
    instagram: { caption: 'O teu valor não cabe numa calça tamanho S. ✨\n\nForam anos a ouvir que só mereces respeito se fores magra.\n\nIsso é mentira.\n\nO ÁUREA trabalha o teu valor próprio:\n✨ 100+ micro-práticas\n✨ 4 áreas: dinheiro, tempo, roupa, prazer\n✨ Check-ins de espelho\n✨ Carteira do valor\n\nLink na bio\n\n#áurea #seteecos #autoestima #valorpróprio #maputo #moçambique #empoderamento #reels' },
    facebook: 'O teu valor não cabe numa calça tamanho S.\n\nO ÁUREA: 100+ micro-práticas de valor próprio.\n\n— Vivianne | ÁUREA',
    whatsapp: '✨ O teu valor não cabe numa calça tamanho S.\n\nO ÁUREA: 100+ micro-práticas em 4 áreas.\n\n👉 app.seteecos.com/aurea',
    tiktok: { ideia: 'REEL — Fundo DOURADO (#C9A227):\n\n"O teu valor não cabe numa calça tamanho S."\n[pausa]\n"Isso. É. Mentira."\n[mostrar mockup Áurea]\n"ÁUREA ✨ — link na bio."', caption: 'O teu valor 💛 #áurea #seteecos #valorpróprio #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'O teu valor não cabe numa calça tamanho S.', subtitulo: 'ÁUREA — 100+ micro-práticas de valor próprio.', caption: '' },
    dica: 'REEL — Fundo DOURADO (#C9A227) obrigatório. Usar mockups Aurea-Dash-portrait.png ou Aurea-praticas-portrait.png. NUNCA fundo verde.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'SERENA — Choras sem saber porquê?',
    eco: 'serena',
    template: 'dica',
    formato: 'reel',
    ...
    corpo: 'O SERENA mapeia 16 emoções no teu corpo. Quando as nomeias, elas perdem poder sobre ti.\n\n💧 6 técnicas de respiração\n💧 Diário emocional\n💧 Detector de padrões\n💧 SOS para momentos de crise\n\nNão é terapia. É consciência.',
    cta: 'Link na bio.',
    instagram: { caption: 'Choras sem saber porquê? 💧\n\nNão é fraqueza. É o teu corpo a pedir atenção.\n\nO SERENA mapeia 16 emoções no teu corpo.\n\n💧 6 técnicas de respiração\n💧 Diário emocional\n💧 Detector de padrões\n💧 SOS para crises\n\nNão é terapia. É consciência.\n\nLink na bio\n\n#serena #seteecos #emoções #saúdemental #respiração #maputo #moçambique #reels' },
    facebook: 'Choras sem saber porquê? Não é fraqueza.\n\nO SERENA mapeia 16 emoções no teu corpo.\n\n— Vivianne | SERENA',
    whatsapp: '💧 Já choraste sem saber porquê?\n\nO SERENA: 16 emoções, 6 respirações, SOS para crises.\n\n👉 app.seteecos.com/serena',
    tiktok: { ideia: 'REEL — Fundo AZUL (#6B8E9B), música calma:\n\n"Choras sem saber porquê?"\n[pausa]\n"Não é fraqueza."\n[mostrar mockup Serena]\n"16 emoções mapeadas."\n"SERENA 💧"', caption: 'Choras sem saber porquê? 💧 #serena #seteecos #emoções #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'Choras sem saber porquê?', subtitulo: 'Não é fraqueza. SERENA — emoções e fluidez.', caption: '' },
    dica: 'REEL — Fundo AZUL (#6B8E9B) obrigatório. Usar mockups Serena-dash-portrait.png ou Serena-praticas-portrait.png. Música suave. NUNCA fundo verde.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'IGNIS — Onde está o teu foco?',
    eco: 'ignis',
    template: 'dica',
    formato: 'reel',
    mockups: ['/mockups/Ignis-dash-portrait.png', '/mockups/Ignis-escolhas-portrait.png'],
    hook: 'Pegas no telemóvel para ver as horas e 40 minutos depois estás no Instagram. Reconheces?',
    corpo: 'O teu foco foi roubado. Não é falta de disciplina — é falta de sistema.\n\nO IGNIS:\n🔥 Detector de distracções\n🔥 16 desafios de fogo\n🔥 Sessões de foco cronometradas\n🔥 Diário de conquistas\n🔥 Bússola de valores',
    cta: 'Link na bio.',
    instagram: { caption: 'Pegas no telemóvel para ver as horas.\n40 minutos depois estás no Instagram. 🔥\n\nO teu foco foi roubado. Não é falta de disciplina.\n\nO IGNIS:\n🔥 Detector de distracções\n🔥 16 desafios de fogo\n🔥 Sessões cronometradas\n🔥 Diário de conquistas\n\nRecupera o teu foco.\n\nLink na bio\n\n#ignis #seteecos #foco #disciplina #produtividade #maputo #moçambique #reels' },
    facebook: 'Pegas no telemóvel para ver as horas. 40 minutos depois estás no Instagram.\n\nO IGNIS recupera o teu foco com 16 desafios.\n\n— Vivianne | IGNIS',
    whatsapp: '🔥 Pegas no telemóvel para ver as horas e 40 minutos depois...\n\nO IGNIS: detector de distracções + 16 desafios de fogo.\n\n👉 app.seteecos.com/ignis',
    tiktok: { ideia: 'REEL — Fundo TERRACOTA (#C1634A):\n\n"Pegas no telemóvel para ver as horas."\n"40 minutos depois estás no Instagram."\n[pausa]\n"O teu foco foi roubado."\n[mostrar mockup Ignis]\n"IGNIS 🔥 — link na bio."', caption: '40 minutos depois... 🔥 #ignis #seteecos #foco #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'Pegas no telemóvel para ver as horas.', subtitulo: '40 minutos depois estás no Instagram. IGNIS.', caption: '' },
    dica: 'REEL — Fundo TERRACOTA (#C1634A) obrigatório. Usar mockups Ignis-dash-portrait.png ou Ignis-escolhas-portrait.png. Hook muito relatable. NUNCA fundo verde.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'VENTIS — Estás cansada. Não é preguiça.',
    eco: 'ventis',
    template: 'dica',
    formato: 'reel',
    ...
    corpo: 'O teu corpo tem picos e vales de energia. Se ignoras o ritmo, rebenta.\n\nO VENTIS:\n🍃 Monitor de energia\n🍃 Pausas conscientes (8 tipos)\n🍃 Detector de burnout\n🍃 Movimentos: yoga, tai chi, dança\n🍃 Conexão com a natureza',
    cta: 'Link na bio.',
    instagram: { caption: 'Estás cansada e não sabes porquê. 🍃\n\nNão é preguiça. É falta de ritmo.\n\nO VENTIS:\n🍃 Monitor de energia\n🍃 Pausas conscientes\n🍃 Detector de burnout\n🍃 Movimentos: yoga, tai chi, dança\n🍃 Conexão com a natureza\n\nEncontra o teu ritmo.\n\nLink na bio\n\n#ventis #seteecos #energia #burnout #ritmo #maputo #moçambique #reels' },
    facebook: 'Estás cansada e não sabes porquê. Não é preguiça. É falta de ritmo.\n\nO VENTIS encontra o teu ritmo natural.\n\n— Vivianne | VENTIS',
    whatsapp: '🍃 Estás cansada e não sabes porquê?\n\nO VENTIS: monitor de energia + detector de burnout.\n\n👉 app.seteecos.com/ventis',
    tiktok: { ideia: 'REEL — Fundo TEAL (#5D9B84):\n\n"Estás cansada."\n"Não é preguiça."\n"É falta de ritmo."\n[mostrar mockup Ventis]\n"VENTIS 🍃 — link na bio."', caption: 'Não é preguiça 🍃 #ventis #seteecos #energia #fyp #burnout' },
    conteudoIG: { tipo: 'dica', texto: 'Estás cansada e não sabes porquê.', subtitulo: 'Não é preguiça. VENTIS — energia e ritmo.', caption: '' },
    dica: 'REEL — Fundo TEAL (#5D9B84) obrigatório. Usar mockups Ventis-dash-portrait.png ou Ventis-praticas-portrait.png. NUNCA fundo verde.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'ECOA — Quantas vezes engoliste?',
    eco: 'ecoa',
    template: 'dica',
    formato: 'reel',
    ...
    corpo: 'A tua voz foi silenciada. Pelo medo. Pela educação. Pela sobrevivência.\n\nO ECOA:\n🔊 Mapa de silenciamento\n🔊 Programa Micro-Voz (8 semanas)\n🔊 Cartas não enviadas\n🔊 Afirmações diárias\n🔊 Comunicação assertiva\n\nRecupera a tua voz.',
    cta: 'Link na bio.',
    instagram: { caption: 'Quantas vezes engoliste o que querias dizer? 🔊\n\nIsso acumula no corpo.\n\nO ECOA:\n🔊 Mapa de silenciamento\n🔊 Programa Micro-Voz (8 semanas)\n🔊 Cartas não enviadas\n🔊 Afirmações diárias\n🔊 Comunicação assertiva\n\nRecupera a tua voz.\n\nLink na bio\n\n#ecoa #seteecos #voz #expressão #comunicação #maputo #moçambique #reels' },
    facebook: 'Quantas vezes engoliste o que querias dizer? Isso acumula no corpo.\n\nO ECOA recupera a tua voz em 8 semanas.\n\n— Vivianne | ECOA',
    whatsapp: '🔊 Quantas vezes engoliste o que querias dizer?\n\nO ECOA: programa Micro-Voz de 8 semanas.\n\n👉 app.seteecos.com/ecoa',
    tiktok: { ideia: 'REEL — Fundo AZUL OCEANO (#4A90A4):\n\n"Quantas vezes engoliste o que querias dizer?"\n[pausa]\n"Isso acumula. No corpo."\n[mostrar mockup Ecoa]\n"ECOA 🔊 — link na bio."', caption: 'Engoliste? 🔊 #ecoa #seteecos #voz #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'Quantas vezes engoliste o que querias dizer?', subtitulo: 'Isso acumula no corpo. ECOA — recupera a tua voz.', caption: '' },
    dica: 'REEL — Fundo AZUL OCEANO (#4A90A4) obrigatório. Usar mockups Ecoa-dash-portrait.png ou Ecoa-praticas-portrait.png. NUNCA fundo verde.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'IMAGO — Quem és tu sem a máscara?',
    eco: 'imago',
    template: 'dica',
    formato: 'reel',
    ...
    corpo: 'O IMAGO é o programa de identidade.\n\n⭐ Espelho triplo (essência, máscara, aspiração)\n⭐ Arqueologia pessoal (5 camadas)\n⭐ 50 valores para descobrires quem és\n⭐ Cerimónia de nomeação\n⭐ 5 meditações guiadas\n\nDescobre quem realmente és.',
    cta: 'Link na bio.',
    instagram: { caption: 'Quem és tu quando ninguém está a ver? ⭐\n\nA maioria de nós não sabe.\n\nO IMAGO:\n⭐ Espelho triplo\n⭐ Arqueologia pessoal\n⭐ 50 valores\n⭐ Cerimónia de nomeação\n⭐ 5 meditações guiadas\n\nDescobre quem realmente és.\n\nLink na bio\n\n#imago #seteecos #identidade #autoconhecimento #maputo #moçambique #reels' },
    facebook: 'Quem és tu quando ninguém está a ver?\n\nO IMAGO explora a tua identidade com espelho triplo e 50 valores.\n\n— Vivianne | IMAGO',
    whatsapp: '⭐ Quem és tu quando ninguém está a ver?\n\nO IMAGO: espelho triplo, 50 valores, meditações guiadas.\n\n👉 app.seteecos.com/imago',
    tiktok: { ideia: 'REEL — Fundo ROXO (#8B7BA5), música introspectiva:\n\n"Quem és tu..."\n"...quando ninguém está a ver?"\n[mostrar mockup Imago]\n"IMAGO ⭐ — link na bio."', caption: 'Quem és tu? ⭐ #imago #seteecos #identidade #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'Quem és tu quando ninguém está a ver?', subtitulo: 'A maioria de nós não sabe. IMAGO — identidade.', caption: '' },
    dica: 'REEL — Fundo ROXO (#8B7BA5) obrigatório. Usar mockups Imago-dash-portrait.png ou Imago-arqueologia-portrait.png. NUNCA fundo verde.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'Começa grátis — o primeiro passo é teu.',
    eco: 'lumina',
    template: 'cta',
    formato: 'reel',
    hook: 'Nos últimos dias mostrei-te 7 dimensões. Agora é a tua vez.',
    corpo: 'O Lumina é gratuito. 2 minutos. Sem cartão.\n\nResponde a 7 perguntas e recebe uma leitura personalizada sobre como estás — de verdade.\n\nÉ o primeiro passo. Sem compromisso.',
    cta: 'Experimenta agora: app.seteecos.com/lumina',
    instagram: { caption: 'Nos últimos dias mostrei-te 7 dimensões de transformação. 🌿\n\nAgora é a tua vez.\n\nO LUMINA é:\n✅ Gratuito\n✅ 2 minutos\n✅ Sem cartão\n✅ 23 leituras possíveis\n\n🔗 Link na bio\n\n#lumina #seteecos #diagnóstico #grátis #começahoje #maputo #moçambique #reels' },
    facebook: 'Mostrei-te 7 dimensões. Agora é a tua vez.\n\nLUMINA: gratuito. 2 minutos. 23 leituras.\n\n→ app.seteecos.com/lumina\n\n— Vivianne | Sete Ecos',
    whatsapp: '🤍 Agora é a tua vez.\n\nLUMINA: gratuito. 2 minutos. 23 leituras possíveis.\n\n👉 app.seteecos.com/lumina',
    tiktok: { ideia: 'REEL — Recap (fundo muda de cor a cada eco):\n\n🌿 Corpo\n✨ Valor\n💧 Emoção\n🔥 Foco\n🍃 Energia\n🔊 Voz\n⭐ Identidade\n[fundo branco]\n"Agora é a TUA vez."\n"2 minutos. Grátis. Link na bio."', caption: 'Agora é a tua vez 🌿 #seteecos #lumina #grátis #fyp' },
    conteudoIG: { tipo: 'cta', texto: 'Agora é a tua vez.', subtitulo: '2 minutos. Grátis. 23 leituras. LUMINA.', caption: '' },
    dica: 'REEL — Recap de todas as cores (cada eco aparece com a SUA cor, 1 segundo cada). Termina com CTA forte para o Lumina. Último post da campanha.',
  },
];
