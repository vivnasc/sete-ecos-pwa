...
// ============================================================
// CAMPANHA DE LANÇAMENTO DO ZERO — 10 posts para conta nova
// Sem exposição pessoal: texto em ecrã, imagens, screen recordings
// Fases: Quem somos → O que é Sete Ecos → Apresentar cada Eco
// ============================================================

const LANCAMENTO_POSTS = [
  // === FASE 1: QUEM SOMOS (Posts 1-3) ===
  {
    dia: 1,
    fase: 1,
    faseTitulo: 'Quem somos',
    ...
    dica: 'Formato: texto animado em ecrã + música trending calma. Sem cara, sem voz. Publica como Reel E como post estático.',
  },
  {
    dia: 2,
    fase: 1,
    faseTitulo: 'Quem somos',
    titulo: '5 coisas que ninguém te conta',
    eco: 'seteEcos',
    template: 'carrossel',
    hook: '5 coisas que ninguém te conta sobre bem-estar',
    corpo: 'O bem-estar não é só dieta. É emoção, energia, voz, identidade, foco, valor próprio e corpo — tudo junto.',
    cta: 'Desliza e guarda para reler.',
    instagram: { caption: '5 coisas que ninguém te conta sobre bem-estar 👇\n\nDesliza.\n\nGuarda este post — vais querer voltar a ele.\n\n#seteecos #bemestar #saúde #autoconhecimento #verdade #transformação #moçambique #wellness' },
    facebook: '5 coisas que ninguém te conta sobre bem-estar:\n\n1. Dieta sem trabalho emocional não funciona\n2. O teu corpo fala — tu é que não ouves\n3. Energia não é café. É ritmo de vida\n4. A tua voz foi silenciada. Podes recuperá-la\n5. Transformação real toca 7 dimensões, não 1\n\n— Vivianne | Sete Ecos',
    whatsapp: '5 coisas que ninguém te conta sobre bem-estar:\n\n1. Dieta sem trabalho emocional não funciona\n2. O teu corpo fala — tu é que não ouves\n3. Energia não é café. É ritmo de vida\n4. A tua voz foi silenciada. Podes recuperá-la\n5. Transformação real toca 7 dimensões, não 1',
    tiktok: { ideia: 'TEXTO EM ECRÃ (cada ponto aparece um de cada vez):\n\n"5 coisas que ninguém te conta sobre bem-estar"\n\n1. "Dieta sem trabalho emocional não funciona"\n2. "O teu corpo fala — tu é que não ouves"\n3. "Energia não é café. É ritmo de vida"\n4. "A tua voz foi silenciada"\n5. "Transformação real toca 7 dimensões, não 1"', caption: '5 verdades 💥 #seteecos #bemestar #fyp #verdade' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: '5 coisas que ninguém te conta',
      texto: 'Desliza para descobrir.',
      slides: [
        { titulo: '1. Dieta sozinha não funciona', texto: 'Se não trabalhares as emoções por trás da comida, vais sempre voltar ao mesmo ponto.' },
        { titulo: '2. O teu corpo fala', texto: 'Cansaço, tensão, insónia — são mensagens. Tu é que não estás a ouvir.' },
        { titulo: '3. Energia não é café', texto: 'É ritmo. É saber quando parar e quando avançar. A maioria de nós vive no modo automático.' },
        { titulo: '4. A tua voz foi silenciada', texto: 'Quantas vezes engoliste o que querias dizer? Isso acumula no corpo.' },
        { titulo: '5. Transformação é integral', texto: 'Corpo, emoção, energia, foco, voz, identidade, valor próprio. 7 dimensões. Todas contam.' },
      ],
      caption: '',
    },
    dica: 'Formato: carrossel de 5 slides coloridos. Texto grande e simples. Descarrega as imagens e publica.',
  },
  {
    dia: 3,
    fase: 1,
    faseTitulo: 'Quem somos',
    titulo: 'Não somos mais uma app de dieta',
    eco: 'seteEcos',
    template: 'cta',
    hook: 'Isto não é mais uma app de dieta. É um sistema de transmutação integral.',
    corpo: 'A maioria das apps foca no corpo. Nós focamos em ti — inteira.\n\n7 dimensões. 7 programas. 1 sistema.\n\nCorpo. Emoção. Energia. Foco. Voz. Identidade. Valor próprio.\n\nChama-se Sete Ecos.',
    cta: 'Nos próximos dias vais conhecer cada um. Segue para não perderes.',
    instagram: { caption: 'Isto NÃO é mais uma app de dieta. 🙅\n\nÉ um sistema de transmutação integral.\n\n7 dimensões:\n🥗 Corpo (Vitalis)\n💧 Emoção (Serena)\n🍃 Energia (Ventis)\n🔥 Foco (Ignis)\n🔊 Voz (Ecoa)\n⭐ Identidade (Imago)\n✨ Valor próprio (Áurea)\n\nChama-se Sete Ecos.\n\nNos próximos dias vais conhecer cada um. Segue.\n\n#seteecos #transformação #bemestar #holístico #saúde #moçambique #wellness #7dimensões' },
    facebook: 'Isto NÃO é mais uma app de dieta.\n\nÉ um sistema de transmutação integral com 7 dimensões:\n\nCorpo • Emoção • Energia • Foco • Voz • Identidade • Valor próprio\n\nChama-se Sete Ecos.\n\nNos próximos dias vais conhecer cada um.\n\n— Vivianne | Sete Ecos',
    whatsapp: 'Olá 🤍\n\nCriei algo que não existe em Moçambique: um sistema com 7 dimensões de transformação.\n\nCorpo • Emoção • Energia • Foco • Voz • Identidade • Valor próprio.\n\nChama-se Sete Ecos. Segue @seteecos no Instagram para conheceres cada dimensão.',
    tiktok: { ideia: 'TEXTO EM ECRÃ (revelação dramática, fundo escuro):\n\n"Isto não é uma app de dieta."\n[pausa]\n"É um sistema com 7 dimensões."\n[lista aparece uma a uma]\n"Corpo • Emoção • Energia"\n"Foco • Voz • Identidade"\n"Valor próprio"\n[pausa]\n"Chama-se Sete Ecos."\n"Segue para conhecer cada uma."', caption: '7 dimensões. 1 sistema. 🌿 #seteecos #fyp #transformação #bemestar' },
    conteudoIG: { tipo: 'cta', texto: 'Isto não é mais uma app de dieta.', subtitulo: '7 dimensões. 1 sistema. Sete Ecos.', caption: '' },
    dica: 'Formato: Reel com texto em ecrã (revelação dramática). Também funciona como post estático.',
  },

  // === FASE 2: O QUE É SETE ECOS (Posts 4-6) ===
  {
    dia: 4,
    fase: 2,
    faseTitulo: 'Os 7 Ecos',
    titulo: 'LUMINA — O diagnóstico gratuito',
    eco: 'lumina',
    template: 'dica',
    hook: '7 perguntas. 2 minutos. 23 leituras possíveis. E é grátis.',
    corpo: 'O LUMINA é um diagnóstico que analisa 8 dimensões da tua vida: corpo, energia, mente, emoção, conexão e mais.\n\nNão é um quiz genérico. É uma leitura personalizada que revela padrões que não vias.\n\nE sim — é completamente gratuito.',
    cta: 'Experimenta: app.seteecos.com/lumina',
    instagram: { caption: '7 perguntas. 2 minutos. 23 leituras possíveis.\nE é grátis. 🔮\n\nO LUMINA é o primeiro passo do sistema Sete Ecos.\n\nAnalisa 8 dimensões da tua vida e revela padrões que não vias.\n\nNão é quiz genérico. É leitura personalizada.\n\n🔗 Link na bio\n\n#lumina #seteecos #diagnóstico #autoconhecimento #grátis #bemestar #saúde #moçambique' },
    facebook: '7 perguntas. 2 minutos. 23 leituras possíveis. E é grátis. 🔮\n\nO LUMINA analisa 8 dimensões da tua vida e revela padrões que não vias.\n\nExperimenta: app.seteecos.com/lumina\n\n— Vivianne | Sete Ecos',
    whatsapp: 'Faz-te 7 perguntas e revela padrões que não vias sobre ti.\n\nÉ grátis. Leva 2 minutos.\n\n23 leituras possíveis. Qual vai ser a tua?\n\n👉 app.seteecos.com/lumina',
    tiktok: { ideia: 'SCREEN RECORDING do telemóvel:\n\nTexto antes: "Fiz este teste e fiquei de boca aberta 😳"\n\n[gravar ecrã a abrir app.seteecos.com/lumina]\n[mostrar as perguntas a serem respondidas]\n[mostrar o resultado final]\n\nTexto depois: "É grátis. Link na bio."', caption: 'Fiz este teste grátis e... 😳 #seteecos #lumina #teste #fyp #autoconhecimento' },
    conteudoIG: { tipo: 'dica', texto: '7 perguntas. 2 minutos. 23 leituras. Grátis.', subtitulo: 'LUMINA — o diagnóstico que revela o que não vias.', caption: '' },
    dica: 'Formato ideal: screen recording do Lumina (grava o ecrã do telemóvel a fazer o teste). Funciona muito bem no TikTok.',
  },
  {
    dia: 5,
    fase: 2,
    faseTitulo: 'Os 7 Ecos',
    titulo: 'VITALIS — Corpo e Nutrição',
    eco: 'vitalis',
    template: 'dica',
    hook: 'O problema não é o que comes. É o que te come por dentro.',
    corpo: 'O VITALIS é coaching nutricional real. Plano feito para ti. Receitas com ingredientes que encontras no mercado. Sem restrição, sem culpa.\n\nRastreia sono, água, energia e alimentação juntos — porque o corpo é um sistema, não uma balança.',
    cta: 'Começa com 7 dias grátis. Link na bio.',
    instagram: { caption: 'O problema não é o que comes.\nÉ o que te come por dentro. 🥗\n\nO VITALIS é coaching nutricional real:\n\n🍽 Plano alimentar feito para TI\n📱 Coach IA disponível 24h\n💚 Espaço emocional para dias difíceis\n📊 Rastreio de sono, água e energia\n📖 Receitas com comida real\n\nSem restrição. Sem culpa. Com ciência.\n\n7 dias grátis → link na bio\n\n#vitalis #seteecos #nutrição #coaching #saúde #comidadereal #moçambique #bemestar' },
    facebook: 'O problema não é o que comes. É o que te come por dentro.\n\nO VITALIS é coaching nutricional real. Plano feito para ti. Receitas acessíveis. Sem restrição, sem culpa.\n\n7 dias grátis → app.seteecos.com/vitalis\n\n— Vivianne | VITALIS',
    whatsapp: 'O problema não é o que comes. É o que te come por dentro.\n\nO VITALIS é coaching nutricional real:\n🍽 Plano alimentar personalizado\n📱 Coach IA 24h\n📖 Receitas com comida real\n\n7 dias grátis 👉 app.seteecos.com/vitalis',
    tiktok: { ideia: 'TEXTO EM ECRÃ (fundo com imagens de comida real/mercado):\n\n"O problema não é o que comes."\n[pausa]\n"É o que te come por dentro."\n[pausa]\n"Plano nutricional feito para TI."\n"Receitas com o que encontras no mercado."\n"Sem restrição. Sem culpa."\n[pausa]\n"VITALIS — link na bio."', caption: 'O que te come por dentro 🥗 #vitalis #seteecos #nutrição #fyp' },
    conteudoIG: { tipo: 'dica', texto: 'O problema não é o que comes.', subtitulo: 'É o que te come por dentro. VITALIS.', caption: '' },
    dica: 'Formato: imagem colorida ou Reel com texto + imagens de comida real. Não precisa de rosto.',
  },
  {
    dia: 6,
    fase: 2,
    faseTitulo: 'Os 7 Ecos',
    titulo: 'SERENA — Emoções e Fluidez',
    eco: 'serena',
    template: 'dica',
    hook: 'Choras sem saber porquê? Não é fraqueza. É o teu corpo a pedir atenção.',
    corpo: 'O SERENA mapeia 16 emoções no teu corpo. Quando as nomeias, elas perdem poder sobre ti.\n\n6 técnicas de respiração. Diário emocional. Detector de padrões. SOS para momentos de crise.\n\nNão é terapia. É consciência.',
    cta: 'Descobre mais: link na bio.',
    instagram: { caption: 'Choras sem saber porquê? 💧\n\nNão é fraqueza. É o teu corpo a pedir atenção.\n\nO SERENA mapeia 16 emoções no teu corpo.\nQuando as nomeias, elas perdem poder sobre ti.\n\n💧 6 técnicas de respiração\n💧 Diário emocional\n💧 Detector de padrões\n💧 SOS para momentos de crise\n\nNão é terapia. É consciência.\n\n#serena #seteecos #emoções #saúdemental #respiração #autoconhecimento #moçambique' },
    facebook: 'Choras sem saber porquê? Não é fraqueza. É o teu corpo a pedir atenção.\n\nO SERENA mapeia 16 emoções no teu corpo. Quando as nomeias, elas perdem poder sobre ti.\n\n— Vivianne | SERENA',
    whatsapp: 'Já choraste sem saber porquê?\n\nO SERENA mapeia 16 emoções no teu corpo. 6 técnicas de respiração. SOS para crises.\n\nQuando nomeias o que sentes, tudo muda.\n\n👉 app.seteecos.com/serena',
    tiktok: { ideia: 'TEXTO EM ECRÃ (fundo azul calmo, música emocional):\n\n"Choras sem saber porquê?"\n[pausa]\n"Não é fraqueza."\n"É o teu corpo a pedir atenção."\n[pausa]\n"16 emoções mapeadas no corpo."\n"Quando as nomeias..."\n"...elas perdem poder sobre ti."\n[pausa]\n"SERENA 💧"', caption: 'Choras sem saber porquê? 💧 #serena #seteecos #emoções #fyp #saúdemental' },
    conteudoIG: { tipo: 'dica', texto: 'Choras sem saber porquê?', subtitulo: 'Não é fraqueza. É o teu corpo a pedir atenção.', caption: '' },
    dica: 'Formato: Reel com texto calmo sobre fundo azul. Música suave. Muito partilhável.',
  },

  // === FASE 3: MAIS ECOS + CTA (Posts 7-10) ===
  {
    dia: 7,
    fase: 3,
    faseTitulo: 'Apresentar e conectar',
    titulo: 'ÁUREA — Valor Próprio',
    eco: 'aurea',
    template: 'dica',
    hook: 'O teu valor não cabe numa calça tamanho S.',
    corpo: 'Foste ensinada a acreditar que só mereces respeito se fores magra. Que só és bonita se a roupa for pequena.\n\nIsso é mentira.\n\nO ÁUREA trabalha o teu valor próprio através de 100 micro-práticas em 4 áreas: dinheiro, tempo, roupa e prazer.',
    cta: 'Descobre mais: link na bio.',
    instagram: { caption: 'O teu valor não cabe numa calça tamanho S. ✨\n\nForam anos a ouvir que só mereces respeito se fores magra.\n\nIsso é mentira.\n\nO ÁUREA trabalha o teu valor próprio:\n✨ 100+ micro-práticas\n✨ 4 áreas: dinheiro, tempo, roupa, prazer\n✨ Check-ins de espelho\n✨ Carteira do valor\n\nLink na bio.\n\n#áurea #seteecos #autoestima #valorpróprio #mulherforte #moçambique #empoderamento' },
    facebook: 'O teu valor não cabe numa calça tamanho S.\n\nForam anos a ouvir que só mereces respeito se fores magra. Isso é mentira.\n\nO ÁUREA trabalha o teu valor próprio com 100+ micro-práticas.\n\n— Vivianne | ÁUREA',
    whatsapp: 'O teu valor não cabe numa calça tamanho S.\n\nO ÁUREA é um programa de valor próprio. 100+ micro-práticas em 4 áreas: dinheiro, tempo, roupa e prazer.\n\n✨ Descobre: app.seteecos.com/aurea',
    tiktok: { ideia: 'TEXTO EM ECRÃ (fundo dourado, música empoderamento):\n\n"O teu valor não cabe numa calça tamanho S."\n[pausa]\n"Foram anos a ouvir que só mereces respeito se fores magra."\n[pausa]\n"Isso. É. Mentira."\n[pausa]\n"ÁUREA ✨ — valor próprio em 4 áreas."', caption: 'O teu valor 💛 #áurea #seteecos #valorpróprio #fyp #empoderamento' },
    ...
    dica: 'Formato: Reel dramático. Fundo dourado. Texto forte. Muito viral.',
  },
  {
    dia: 8,
    fase: 3,
    faseTitulo: 'Apresentar e conectar',
    titulo: 'IGNIS + VENTIS + ECOA — Foco, Energia e Voz',
    eco: 'seteEcos',
    template: 'carrossel',
    hook: 'Foco. Energia. Voz. As 3 coisas que te roubaram e podes recuperar.',
    corpo: 'IGNIS 🔥 — Recupera o teu foco. Detector de distracções. Desafios de fogo.\n\nVENTIS 🍃 — Encontra o teu ritmo. Monitor de energia. Detector de burnout.\n\nECOA 🔊 — Recupera a tua voz. 8 semanas de programa Micro-Voz.',
    cta: 'Qual é a tua prioridade? Comenta abaixo.',
    instagram: { caption: 'Foco. Energia. Voz. 🔥🍃🔊\n\nAs 3 coisas que te roubaram e que podes recuperar.\n\nDesliza para conhecer cada uma.\n\nQual é a tua prioridade? Comenta.\n\n#seteecos #foco #energia #voz #ignis #ventis #ecoa #transformação #moçambique' },
    facebook: 'Foco. Energia. Voz.\n\n3 coisas que te roubaram e que podes recuperar:\n\n🔥 IGNIS — Foco e disciplina consciente\n🍃 VENTIS — Energia e ritmo de vida\n🔊 ECOA — A voz que silenciaste\n\nQual é a tua prioridade?\n\n— Vivianne | Sete Ecos',
    whatsapp: 'Foco. Energia. Voz.\n\n3 coisas que te roubaram:\n\n🔥 IGNIS — recupera o foco\n🍃 VENTIS — encontra o teu ritmo\n🔊 ECOA — recupera a tua voz\n\nQual é a tua prioridade?',
    tiktok: { ideia: 'TEXTO EM ECRÃ (3 cores, cada eco com a sua):\n\n"3 coisas que te roubaram:"\n\n🔥 "O teu FOCO" (fundo vermelho)\n🍃 "A tua ENERGIA" (fundo verde)\n🔊 "A tua VOZ" (fundo roxo)\n\n[pausa]\n"Podes recuperar as 3."\n"Sete Ecos — link na bio."', caption: 'O que te roubaram 🔥🍃🔊 #seteecos #foco #energia #voz #fyp' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'Foco • Energia • Voz',
      texto: '3 dimensões para recuperar.',
      slides: [
        { titulo: '🔥 IGNIS — Foco', texto: 'Detector de distracções. 16 desafios de fogo. Diário de conquistas. Recupera a tua disciplina consciente.' },
        { titulo: '🍃 VENTIS — Energia', texto: 'Monitor de energia. Pausas conscientes. Detector de burnout. Encontra o teu ritmo.' },
        { titulo: '🔊 ECOA — Voz', texto: '8 semanas de programa Micro-Voz. Cartas não enviadas. Afirmações diárias. Recupera o que silenciaste.' },
        { titulo: 'Qual é a tua prioridade?', texto: 'Comenta: 🔥 foco, 🍃 energia ou 🔊 voz. Queremos saber.' },
      ],
      caption: '',
    },
    dica: 'Formato: carrossel com 4 slides. Cada eco com a sua cor. O último slide pede interacção.',
  },
  {
    dia: 9,
    fase: 3,
    faseTitulo: 'Apresentar e conectar',
    titulo: 'IMAGO + AURORA — Identidade e Integração',
    eco: 'seteEcos',
    template: 'dica',
    hook: 'Quem és tu quando ninguém está a ver?',
    corpo: 'O IMAGO é o programa de identidade. Espelho triplo, arqueologia pessoal, 50 valores para descobrires quem realmente és.\n\nE quando completares os 7 Ecos, o AURORA desbloqueia — a graduação. O ritual final. A integração de tudo o que aprendeste.',
    cta: '7 dimensões. 1 jornada. Tu no centro.',
    instagram: { caption: 'Quem és tu quando ninguém está a ver? ⭐\n\nO IMAGO é o programa de identidade.\nEspelho triplo. Arqueologia pessoal. 50 valores.\n\nE quando completares os 7 Ecos...\n...o AURORA 🌅 desbloqueia.\n\nA graduação. O ritual final.\nA integração de tudo.\n\n7 dimensões. 1 jornada. Tu no centro.\n\n#imago #aurora #seteecos #identidade #autoconhecimento #jornada #transformação #moçambique' },
    facebook: 'Quem és tu quando ninguém está a ver?\n\nO IMAGO explora a tua identidade. E quando completares os 7 Ecos, o AURORA desbloqueia — a integração final.\n\n7 dimensões. 1 jornada. Tu no centro.\n\n— Vivianne | Sete Ecos',
    whatsapp: 'Quem és tu quando ninguém está a ver?\n\nO IMAGO é o programa de identidade.\nO AURORA é a graduação — desbloqueia quando completares os 7 Ecos.\n\n⭐ 7 dimensões. 1 jornada. Tu no centro.',
    tiktok: { ideia: 'TEXTO EM ECRÃ (fundo estrelado, música introspectiva):\n\n"Quem és tu..."\n"...quando ninguém está a ver?"\n[pausa]\n"IMAGO ⭐ — identidade"\n"Espelho triplo. 50 valores."\n[pausa]\n"E quando completares os 7 Ecos..."\n"...o AURORA 🌅 desbloqueia."\n"A graduação final."', caption: 'Quem és tu? ⭐🌅 #seteecos #imago #identidade #fyp #autoconhecimento' },
    conteudoIG: { tipo: 'dica', texto: 'Quem és tu quando ninguém está a ver?', subtitulo: 'IMAGO ⭐ + AURORA 🌅 — identidade e integração.', caption: '' },
    dica: 'Formato: Reel introspectivo. Fundo escuro com estrelas. Texto lento.',
  },
  {
    dia: 10,
    fase: 3,
    faseTitulo: 'Apresentar e conectar',
    titulo: 'Começa grátis — primeiro passo',
    eco: 'lumina',
    template: 'cta',
    hook: 'Nos últimos dias mostrei-te 7 dimensões de transformação. Agora é a tua vez.',
    corpo: 'O Lumina é gratuito. Leva 2 minutos. Não precisa de cartão.\n\nResponde a 7 perguntas e recebe uma leitura personalizada sobre como estás — de verdade.\n\nÉ o primeiro passo. Sem compromisso. Sem pressão. Só tu e 2 minutos.',
    cta: 'Experimenta agora: app.seteecos.com/lumina',
    instagram: { caption: 'Nos últimos dias mostrei-te 7 dimensões de transformação. 🌿\n\nAgora é a tua vez.\n\nO LUMINA é:\n✅ Gratuito\n✅ 2 minutos\n✅ Sem cartão\n✅ 23 leituras possíveis\n\nResponde a 7 perguntas e descobre como estás — de verdade.\n\n🔗 Link na bio\n\n#lumina #seteecos #diagnóstico #grátis #começahoje #bemestar #autoconhecimento #moçambique' },
    facebook: 'Nos últimos dias mostrei-te 7 dimensões de transformação.\n\nAgora é a tua vez.\n\nO LUMINA é gratuito. 2 minutos. Sem cartão. 23 leituras possíveis.\n\nExperimenta: app.seteecos.com/lumina\n\n— Vivianne | Sete Ecos',
    whatsapp: 'Olá 🤍\n\nNos últimos dias falei sobre 7 dimensões de transformação. Agora é a tua vez.\n\nO LUMINA é gratuito. 2 minutos. 7 perguntas. 23 leituras possíveis.\n\nExperimenta e diz-me o que achaste:\n👉 app.seteecos.com/lumina',
    tiktok: { ideia: 'TEXTO EM ECRÃ (fundo que muda de cor a cada frase):\n\n"Nos últimos dias mostrei-te:"\n"🥗 Corpo"\n"💧 Emoção"\n"🍃 Energia"\n"🔥 Foco"\n"🔊 Voz"\n"⭐ Identidade"\n"✨ Valor"\n[pausa, fundo branco]\n"Agora é a TUA vez."\n"2 minutos. Grátis. Link na bio."', caption: 'Agora é a tua vez 🌿 #seteecos #lumina #grátis #fyp #começa' },
    conteudoIG: { tipo: 'cta', texto: 'Agora é a tua vez.', subtitulo: '2 minutos. Grátis. 23 leituras. LUMINA.', caption: '' },
    dica: 'Formato: Reel de recapitulação (7 emojis aparecem um a um). Último post da fase — CTA forte para o Lumina.',
  },
];
