...
const LANCAMENTO_POSTS = [
...

  {
    ...
    instagram: { caption: 'Se isto tocou fundo, guarda.\nNão estás sozinha.\n\n— Vivianne\n\n#saúdemental #autocuidado #mães #cansaço #esgotamento #bemestar #seteecos #maputo #moçambique' },
  ...
  // =================================================================
  // SEMANA 2: VITALIS — PRODUTO HERÓI (Posts 7-11)
  // Objectivo: mostrar a solução com mockups reais
  // =================================================================

  {
    dia: 7,
    fase: 2,
    faseTitulo: 'VITALIS — Produto Herói',
    titulo: '3 coisas que nenhuma dieta te ensina',
    eco: 'vitalis',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL educativo — publica de manhã (9h). Alto potencial de SAVES. Conteúdo que ensina algo novo.',
    hook: 'Nenhuma dieta te ensina isto.',
    corpo: 'Que a fome emocional não se resolve com força de vontade.\nQue o teu ciclo menstrual muda o que o corpo precisa.\nQue comer bem com ingredientes locais não precisa de ser caro.',
    cta: 'Guarda. Envia a quem vive a fazer dietas que não funcionam.',
    audioScript: 'Nenhuma dieta te ensina isto. Primeiro: a fome emocional não se resolve com força de vontade. Comes quando estás triste, ansiosa, aborrecida, e achas que é falta de disciplina. Não é. É emoção a pedir atenção. Segundo: o teu ciclo menstrual muda o que o teu corpo precisa. Na fase lútea precisas de mais hidratos. A ciência diz isto. As dietas ignoram. Terceiro: comer bem com ingredientes do mercado não precisa de ser caro. Matapa, nhemba, couve, feijão. Nutrição real, acessível. Guarda isto. Envia a quem vive a fazer dietas que não funcionam.',
    mockups: ['/mockups/mozproud-vitalis.jpeg'],
    instagram: { caption: 'Nenhuma dieta te ensina isto. Guarda para reler.\n\nEnvia a quem precisa de ouvir.\n\n— Vivianne\n\n#nutrição #dieta #comidareal #fomeemocional #ciclomenstrual #saúde #seteecos #vitalis #maputo' },
    facebook: '3 coisas que nenhuma dieta te ensina:\n\n1. A fome emocional não se resolve com força de vontade\n2. O teu ciclo menstrual muda o que o corpo precisa\n3. Comer bem com ingredientes locais não precisa de ser caro\n\n— Vivianne | VITALIS',
    whatsapp: 'Nenhuma dieta te ensina isto:\n\n1. Fome emocional ≠ falta de disciplina\n2. O ciclo menstrual muda as necessidades\n3. Comer bem não precisa de ser caro\n\nVITALIS: 👉 app.seteecos.com/vitalis',
    tiktok: { ideia: 'CARROSSEL com áudio. Voz pausada, cada ponto revelado lentamente. Música trending calma de fundo.', caption: 'Nenhuma dieta te ensina isto #nutrição #dieta #fomeemocional #fyp #seteecos' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: '3 coisas que as dietas não ensinam',
      texto: 'Nenhuma dieta te ensina isto.',
      subtitulo: 'Guarda e envia a quem precisa.',
      caption: '',
      slides: [
        { titulo: 'Nenhuma dieta te ensina isto.', texto: 'Desliza →' },
        { titulo: '1. A fome emocional não se resolve com força de vontade', texto: 'Comes quando estás triste, ansiosa, aborrecida. Achas que é falta de disciplina. Não é. É emoção a pedir atenção.' },
        { titulo: '2. O teu ciclo menstrual muda tudo', texto: 'Na fase lútea precisas de mais hidratos. A ciência diz isto. As dietas genéricas ignoram completamente.' },
        { titulo: '3. Comer bem não precisa de ser caro', texto: 'Matapa, nhemba, couve, feijão, amendoim. Nutrição real com ingredientes do mercado. Sem listas importadas.' },
        { titulo: 'Guarda. Envia.', texto: 'A quem vive a fazer dietas que não funcionam.\n\n7 dias grátis — link na bio.\napp.seteecos.com/vitalis' },
      ],
    },
    dica: 'CARROSSEL educativo com áudio. 5 slides. Objectivo: SAVES + SHARES. Fundo VERDE (#7C8B6F). Cada slide ensina algo concreto.',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'VITALIS — Produto Herói',
    titulo: 'Isto não é um PDF. É o que recebes.',
    eco: 'vitalis',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL demo — publica entre 12h-14h. Mostrar mockup real do dashboard. Voiceover a explicar.',
    mockups: ['/mockups/Vitalis-dashboard_mb-mockup.jpeg'],
    hook: 'Pagaste por um PDF e nunca mais abriste? Isto é diferente.',
    corpo: 'Isto é o que recebes no VITALIS:\n\nPlano personalizado (não genérico).\n98 receitas filtradas para o teu perfil.\nCheck-in diário que te acompanha.\nCoach disponível 24h.\nEspaço emocional — porque não é só comida.',
    cta: '7 dias grátis. Link na bio.',
    audioScript: 'Pagaste por um PDF e nunca mais abriste? Isto é diferente. Isto é o VITALIS por dentro. Plano personalizado, não genérico. 98 receitas filtradas para o teu perfil e as tuas restrições. Check-in diário que te acompanha. Coach disponível 24 horas. E um espaço emocional, porque não é só comida. 7 dias grátis. Link na bio.',
    instagram: { caption: 'Pagaste por um PDF e nunca mais abriste?\n\nIsto é diferente. Plano personalizado. 98 receitas. Coach 24h. Espaço emocional.\n\n7 dias grátis — link na bio.\n\n— Vivianne\n\n#app #nutrição #planoalimentar #comidareal #coaching #seteecos #vitalis #maputo' },
    facebook: 'Pagaste por um PDF e nunca mais abriste? Isto é diferente.\n\nVITALIS: plano personalizado, 98 receitas, coach 24h, espaço emocional.\n\n7 dias grátis → app.seteecos.com/vitalis\n\n— Vivianne',
    whatsapp: 'Pagaste por um PDF e nunca mais abriste?\n\nVITALIS: plano personalizado, 98 receitas, coach 24h.\n\n7 dias grátis: 👉 app.seteecos.com/vitalis',
    tiktok: { ideia: 'REEL 45s — Mostrar mockup do dashboard VITALIS. Voiceover a descrever cada funcionalidade. Visual limpo, profissional.', caption: 'Não é PDF. É app completa. #nutrição #app #vitalis #fyp #seteecos' },
    conteudoIG: { tipo: 'dica', texto: 'Pagaste por um PDF e nunca mais abriste?', subtitulo: 'Isto é diferente. 7 dias grátis.', caption: '' },
    dica: 'REEL com mockup Vitalis-dashboard. Voiceover ElevenLabs. Fundo VERDE (#7C8B6F). Mostrar que é real, profissional, diferente de PDFs.',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'VITALIS — Produto Herói',
    titulo: 'Comes quando estás triste? Lê isto.',
    eco: 'vitalis',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL emocional — publica entre 18h-20h. Conteúdo de alta identificação. Objectivo: SHARES.',
    hook: 'Comes quando estás triste? Não é falta de disciplina.',
    corpo: 'Comes quando estás ansiosa.\nComes quando estás aborrecida.\nComes quando estás zangada.\nComes quando estás sozinha.\n\nE depois sentes culpa. E a culpa faz-te comer mais.\n\nNão é falta de disciplina. É o teu corpo a usar comida para regular emoções que ninguém te ensinou a processar.',
    cta: 'Guarda. Envia a alguém que precisa de ler isto sem julgamento.',
    audioScript: 'Comes quando estás triste? Não é falta de disciplina. Comes quando estás ansiosa. Quando estás aborrecida. Quando estás zangada. Quando estás sozinha. E depois sentes culpa. E a culpa faz-te comer mais. Não é fraqueza. É o teu corpo a usar comida para regular emoções que ninguém te ensinou a processar. O VITALIS tem um espaço emocional dentro da app. Porque a nutrição sem consciência emocional não funciona.',
    instagram: { caption: 'Comes quando estás triste? Não é falta de disciplina.\n\nÉ o teu corpo a usar comida para regular emoções.\n\nGuarda. Envia a quem precisa de ler sem julgamento.\n\n— Vivianne\n\n#fomeemocional #alimentaçãoemocional #comerbem #saúdemental #autocompaixão #seteecos #vitalis #maputo' },
    facebook: 'Comes quando estás triste? Não é falta de disciplina.\n\nÉ o teu corpo a usar comida para regular emoções que ninguém te ensinou a processar.\n\nEnvia a quem precisa.\n\n— Vivianne | VITALIS',
    whatsapp: 'Comes quando estás triste? Não é falta de disciplina.\n\nÉ o corpo a usar comida para regular emoções.\n\nO VITALIS tem espaço emocional dentro da app.\n\n👉 app.seteecos.com/vitalis (7 dias grátis)',
    tiktok: { ideia: 'CARROSSEL com áudio emocional. Voz suave, pausas longas. Conteúdo de alta identificação — objectivo é shares.', caption: 'Não é falta de disciplina. #fomeemocional #alimentação #saúdemental #fyp #seteecos' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'Fome emocional: o que ninguém te diz',
      texto: 'Comes quando estás triste?',
      subtitulo: 'Não é falta de disciplina.',
      caption: '',
      slides: [
        { titulo: 'Comes quando estás triste?', texto: 'Não é falta de disciplina. Desliza →' },
        { titulo: 'Comes quando estás ansiosa.', texto: 'E achas que é gula.' },
        { titulo: 'Comes quando estás aborrecida.', texto: 'E achas que é preguiça.' },
        { titulo: 'Comes quando estás sozinha.', texto: 'E achas que é fraqueza.' },
        { titulo: 'E depois sentes culpa.', texto: 'E a culpa faz-te comer mais. É um ciclo. Não é defeito teu.' },
        { titulo: 'É o teu corpo a regular emoções.', texto: 'Ninguém te ensinou a processar o que sentes. Não é fraqueza. É falta de ferramentas.' },
        { titulo: 'O VITALIS inclui espaço emocional.', texto: 'Porque nutrição sem consciência emocional não funciona.\n\nGuarda. Envia a quem precisa.\n\napp.seteecos.com/vitalis' },
      ],
    },
    dica: 'CARROSSEL emocional com áudio. 7 slides. Objectivo: SHARES (enviar a amigas). Conteúdo de alta identificação — sem julgamento.',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'VITALIS — Produto Herói',
    titulo: '98 receitas. Zero ingredientes importados.',
    eco: 'vitalis',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL produto — publica entre 11h-13h. Mockup das receitas + voiceover. Foco: acessibilidade.',
    mockups: ['/mockups/Vitalis-receitas_mb-mockup.jpeg'],
    hook: 'Matapa. Nhemba. Feijão. Amendoim. Couve. Nutrição real.',
    corpo: '98 receitas com ingredientes que encontras em qualquer mercado.\n\nFiltradas para o teu perfil. As tuas restrições. O teu objectivo.\n\nNada importado. Nada caro. Nada impossível.\n\nCuidar do corpo não devia ser um privilégio.',
    cta: '7 dias grátis. Link na bio.',
    audioScript: 'Matapa. Nhemba. Feijão. Amendoim. Couve. Isto é nutrição real. 98 receitas com ingredientes que encontras em qualquer mercado. Filtradas para o teu perfil. As tuas restrições. O teu objectivo. Nada importado. Nada caro. Nada impossível. Porque cuidar do corpo não devia ser um privilégio. 7 dias grátis. Link na bio.',
    instagram: { caption: '98 receitas. Ingredientes do mercado. Filtradas para ti.\n\nCuidar do corpo não devia ser um privilégio.\n\n7 dias grátis — link na bio.\n\n— Vivianne\n\n#receitas #comidareal #matapa #nhemba #nutrição #moçambique #maputo #seteecos #vitalis' },
    facebook: '98 receitas com ingredientes do mercado. Nada importado. Nada caro.\n\nCuidar do corpo não devia ser um privilégio.\n\n7 dias grátis → app.seteecos.com/vitalis\n\n— Vivianne',
    whatsapp: '98 receitas reais:\n\nMatapa, nhemba, feijão, couve... tudo do mercado.\n\nFiltradas para o teu perfil.\n\n👉 app.seteecos.com/vitalis (7 dias grátis)',
    tiktok: { ideia: 'REEL 30s — Mockup das receitas. Lista visual dos ingredientes locais. Voiceover: "Matapa. Nhemba. Feijão. Isto é nutrição real."', caption: 'Nutrição real com ingredientes reais #receitas #matapa #nutrição #fyp #seteecos' },
    conteudoIG: { tipo: 'dica', texto: 'Matapa. Nhemba. Feijão. Nutrição real.', subtitulo: '98 receitas. Zero importados.', caption: '' },
    dica: 'REEL com mockup receitas. Voiceover ElevenLabs. Fundo VERDE (#7C8B6F). Foco em ingredientes LOCAIS — moçambicanos. Diferencial forte.',
  },

  {
    ...
    fase: 2,
    faseTitulo: 'VITALIS — Produto Herói',
    titulo: 'Coach 24h. Sem espera. Sem julgamento.',
    eco: 'vitalis',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL produto — publica entre 18h-20h. Mockup do coach + voiceover. Mostrar valor prático.',
    mockups: ['/mockups/Vitalis-coach_mb-mockup.jpeg'],
    hook: 'São 23h. Tens uma dúvida sobre o que comer. Quem respondes?',
    corpo: 'A coach no VITALIS está disponível 24 horas.\n\nPorções. Substituições. Jejum. Treino. Dúvidas.\n\nNão é motivação genérica. É orientação real.\n\nAs dúvidas não esperam pelo horário de consulta.',
    cta: '7 dias grátis. Link na bio.',
    audioScript: 'São 23 horas. Tens uma dúvida sobre o que comer amanhã. Quem respondes? No VITALIS, a coach está disponível 24 horas. Porções. Substituições. Jejum. Treino. O que quiseres. Não é motivação genérica. É orientação real. Porque as dúvidas não esperam pelo horário de consulta. 7 dias grátis. Link na bio.',
    instagram: { caption: '23h. Dúvida sobre o que comer. Quem respondes?\n\nNo VITALIS: coach disponível 24h.\n\nSem espera. Sem julgamento. Sempre lá.\n\n7 dias grátis — link na bio.\n\n— Vivianne\n\n#coaching #nutrição #24h #orientação #seteecos #vitalis #maputo' },
    facebook: '23h. Tens uma dúvida. Quem respondes?\n\nCoach de nutrição disponível 24h no VITALIS.\n\n7 dias grátis → app.seteecos.com/vitalis\n\n— Vivianne',
    whatsapp: 'São 23h e tens uma dúvida sobre o que comer.\n\nNo VITALIS: coach 24h. Sem espera.\n\n👉 app.seteecos.com/vitalis (7 dias grátis)',
    tiktok: { ideia: 'REEL 30s — "23h. Tens uma dúvida." [mostrar mockup coach] "Coach 24h. Sem espera." Voiceover + música trending.', caption: '23h e tens uma dúvida. Quem respondes? #coaching #nutrição #fyp #seteecos' },
    conteudoIG: { tipo: 'dica', texto: '23h. Dúvida sobre o que comer.', subtitulo: 'Coach 24h. Sem espera.', caption: '' },
    dica: 'REEL com mockup coach. Voiceover ElevenLabs. Cenário relatable: questão às 23h. Fundo VERDE (#7C8B6F).',
  },

  // =================================================================
  // SEMANA 3: CADA ECO (Posts 12-17)
  // Objectivo: mostrar profundidade do sistema, 1 eco por dia
  // Alternando carrossel (par) e reel (ímpar)
  // =================================================================

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'Dizes que não tens valor. Mas gastas-te toda nos outros.',
    eco: 'aurea',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL emocional — publica de manhã (9h). Cor DOURADA. Objectivo: SAVES + SHARES.',
    mockups: ['/mockups/Aurea-Dash-portrait.png', '/mockups/Aurea-praticas-portrait.png'],
    hook: 'Gastas-te toda nos outros. E depois perguntas por que estás vazia.',
    corpo: 'Dás tempo a todos menos a ti.\nGastas dinheiro em todos menos em ti.\nVestes o que calha porque "não vale a pena".\nRecusas prazer porque "há coisas mais importantes".\n\nE depois perguntas por que estás vazia.',
    cta: 'Se leste isto e doeu, guarda. O ÁUREA existe para ti.',
    audioScript: 'Gastas-te toda nos outros. E depois perguntas por que estás vazia. Dás tempo a todos, menos a ti. Gastas dinheiro em todos, menos em ti. Vestes o que calha porque não vale a pena. Recusas prazer porque há coisas mais importantes. E depois perguntas por que estás vazia. Se isto doeu, é porque reconheces. O Áurea trabalha exactamente isto. Valor próprio. Não com afirmações. Com micro-práticas reais.',
    instagram: { caption: 'Se leste isto e doeu, guarda.\n\nO ÁUREA: valor próprio com micro-práticas reais. Não afirmações no espelho.\n\nLink na bio.\n\n— Vivianne\n\n#valorpróprio #autoestima #autocuidado #mulheres #seteecos #áurea #maputo' },
    facebook: 'Gastas-te toda nos outros. E depois perguntas por que estás vazia.\n\nO ÁUREA: valor próprio com micro-práticas reais.\n\n— Vivianne | ÁUREA',
    whatsapp: 'Gastas-te toda nos outros. E depois perguntas por que estás vazia.\n\nO ÁUREA: valor próprio com micro-práticas.\n\n👉 app.seteecos.com/aurea',
    tiktok: { ideia: 'CARROSSEL com áudio. Cor dourada. Cada slide bate num ponto de dor diferente. Voz suave mas directa.', caption: 'E depois perguntas por que estás vazia. #valorpróprio #autoestima #fyp #seteecos' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'Porque estás vazia?',
      texto: 'Gastas-te toda nos outros.',
      subtitulo: 'E depois perguntas por que estás vazia.',
      caption: '',
      slides: [
        { titulo: 'Gastas-te toda nos outros.', texto: 'E depois perguntas por que estás vazia. Desliza →' },
        { titulo: 'Dás tempo a todos. Menos a ti.', texto: 'Os filhos, o trabalho, o parceiro. Sempre disponível. Para ti? "Depois."' },
        { titulo: 'Gastas dinheiro em todos. Menos em ti.', texto: 'Escola, renda, contas. Para ti? Sentes culpa.' },
        { titulo: 'Vestes o que calha.', texto: '"Não vale a pena." Mas vale para os outros.' },
        { titulo: 'Recusas prazer.', texto: '"Há coisas mais importantes." Quais? E quando chega a tua vez?' },
        { titulo: 'Se isto doeu, guarda.', texto: 'O ÁUREA trabalha exactamente isto.\nValor próprio com micro-práticas.\n\napp.seteecos.com/aurea' },
      ],
    },
    dica: 'CARROSSEL cor DOURADA (#C9A227). 6 slides. Áudio voiceover. Conteúdo de alta identificação. Objectivo: SHARES para amigas.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'Choras no banho e no dia seguinte sorris.',
    eco: 'serena',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL emocional — publica entre 18h-20h. Cor AZUL. Texto em ecrã + voiceover. Objectivo: identificação.',
    mockups: ['/mockups/Serena-dash-portrait.png'],
    hook: 'Choras no banho. No dia seguinte sorris como se nada fosse.',
    corpo: 'Engoles a raiva porque "não vale a pena".\nIgnoras a tristeza porque "há quem esteja pior".\nFinges que está tudo bem porque "sou forte".\n\nMas o corpo sabe. A insónia sabe. A tensão sabe.\n\nSentir não é fraqueza. É o teu corpo a dar-te informação.',
    cta: 'O SERENA ensina-te a ouvir. Link na bio.',
    audioScript: 'Choras no banho. No dia seguinte sorris como se nada fosse. Engoles a raiva porque não vale a pena. Ignoras a tristeza porque há quem esteja pior. Finges que está tudo bem porque sou forte. Mas o corpo sabe. A insónia sabe. A tensão sabe. Sentir não é fraqueza. É o teu corpo a dar-te informação. O Serena ensina-te a ouvir. Link na bio.',
    instagram: { caption: 'Choras no banho. No dia seguinte sorris.\n\nSentir não é fraqueza. É informação.\n\nO SERENA ensina-te a ouvir. Link na bio.\n\n— Vivianne\n\n#emoções #saúdemental #chorar #sentir #bemestar #seteecos #serena #maputo' },
    facebook: 'Choras no banho. No dia seguinte sorris como se nada fosse.\n\nSentir não é fraqueza. É informação.\n\nO SERENA: 16 emoções mapeadas. 6 técnicas de respiração.\n\n— Vivianne | SERENA',
    whatsapp: 'Choras no banho. No dia seguinte sorris.\n\nSentir não é fraqueza. O SERENA ensina-te a ouvir.\n\n👉 app.seteecos.com/serena',
    tiktok: { ideia: 'REEL 45s — Texto lento em ecrã azul. "Choras no banho." [pausa] "No dia seguinte sorris." Voiceover emocional. Música trending suave.', caption: 'Sentir não é fraqueza. #emoções #saúdemental #fyp #seteecos' },
    conteudoIG: { tipo: 'dica', texto: 'Choras no banho. Sorris no dia seguinte.', subtitulo: 'Sentir não é fraqueza. É informação.', caption: '' },
    dica: 'REEL emocional. Fundo AZUL (#6B8E9B). Texto lento + voiceover. Objectivo: identificação profunda → SHARES.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'Estás ocupada. Mas estás a avançar?',
    eco: 'ignis',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL provocativo — publica de manhã (9h). Cor TERRACOTA. Objectivo: SAVES.',
    mockups: ['/mockups/Ignis-dash-portrait.png'],
    hook: 'Estás ocupada o dia todo. Mas no fim, avançaste em quê?',
    corpo: 'Respondes a mensagens. Apagas fogos. Fazes listas. Atendes toda a gente.\n\nMas no fim do dia: avançaste em quê?\n\nOcupada não é produtiva. Disciplinada não é focada.\n\nO foco real é saber o que importa e proteger isso.',
    cta: 'Guarda se reconheces isto.',
    audioScript: 'Estás ocupada o dia todo. Mas no fim, avançaste em quê? Respondes a mensagens. Apagas fogos. Fazes listas. Atendes toda a gente. Mas no fim do dia, avançaste em quê? Ocupada não é produtiva. Disciplinada não é focada. O foco real é saber o que importa e proteger isso. O Ignis ensina-te exactamente isto.',
    instagram: { caption: 'Ocupada não é produtiva.\nDisciplinada não é focada.\n\nGuarda se reconheces isto.\n\nO IGNIS: foco com propósito. Link na bio.\n\n— Vivianne\n\n#foco #produtividade #disciplina #propósito #seteecos #ignis #maputo' },
    facebook: 'Estás ocupada o dia todo. Mas no fim, avançaste em quê?\n\nOcupada ≠ produtiva. O IGNIS: foco com propósito.\n\n— Vivianne | IGNIS',
    whatsapp: 'Estás ocupada o dia todo. Mas avançaste em quê?\n\nO IGNIS: foco com propósito.\n\n👉 app.seteecos.com/ignis',
    tiktok: { ideia: 'CARROSSEL cor terracota. Cada slide desafia uma crença sobre produtividade. Voiceover directa.', caption: 'Ocupada não é produtiva. #foco #produtividade #fyp #seteecos' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'Ocupada vs focada',
      texto: 'Estás ocupada o dia todo.',
      subtitulo: 'Mas avançaste em quê?',
      caption: '',
      slides: [
        { titulo: 'Estás ocupada o dia todo.', texto: 'Mas avançaste em quê? Desliza →' },
        { titulo: 'Respondes a mensagens. Apagas fogos.', texto: 'Fazes listas. Atendes toda a gente. E no fim do dia: o que é TEU nisso tudo?' },
        { titulo: 'Ocupada não é produtiva.', texto: 'É possível estar ocupada 12h e não avançar nada que realmente importa.' },
        { titulo: 'Disciplina sem direcção é cansaço.', texto: 'Ser disciplinada sem saber para quê é como correr numa roda de hamster.' },
        { titulo: 'O foco real é proteger o que importa.', texto: 'O IGNIS ensina-te isto.\n\nGuarda se reconheces.\n\napp.seteecos.com/ignis' },
      ],
    },
    dica: 'CARROSSEL cor TERRACOTA (#C1634A). 5 slides. Áudio voiceover. Provocativo — desafia a ideia de "ser ocupada = ser produtiva".',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: '3 cafés e ainda estás a arrastar-te?',
    eco: 'ventis',
    template: 'dica',
    formato: 'reel',
    cronograma: 'REEL relatable — publica entre 12h-14h. Cor TEAL. Texto + voiceover. Gancho forte.',
    mockups: ['/mockups/Ventis-dash-portrait.png'],
    hook: '3 cafés e ainda estás a arrastar-te? Não é café que precisas.',
    corpo: 'Precisas de café para acordar.\nDe açúcar para aguentar a tarde.\nDe ecrã para adormecer.\n\nIsso não é energia. É dívida energética.\n\nO teu corpo tem um ritmo natural. Ignorá-lo é o que te cansa.',
    cta: 'O VENTIS encontra o teu ritmo. Link na bio.',
    audioScript: 'Três cafés e ainda estás a arrastar-te? Não é café que precisas. Precisas de café para acordar. De açúcar para aguentar a tarde. De ecrã para adormecer. Isso não é energia. É dívida energética. O teu corpo tem um ritmo natural. Ignorá-lo é o que te cansa. O Ventis encontra o teu ritmo. Link na bio.',
    instagram: { caption: '3 cafés e ainda te arrastas?\n\nNão é café que precisas. É ritmo.\n\nO VENTIS: monitor de energia + detector de burnout. Link na bio.\n\n— Vivianne\n\n#energia #burnout #cansaço #café #ritmo #seteecos #ventis #maputo' },
    facebook: '3 cafés e ainda te arrastas? Não é café que precisas.\n\nO VENTIS encontra o teu ritmo natural.\n\n— Vivianne | VENTIS',
    whatsapp: '3 cafés e ainda te arrastas?\n\nNão é café que precisas. É ritmo.\n\n👉 app.seteecos.com/ventis',
    tiktok: { ideia: 'REEL 30s — "3 cafés. Ainda te arrastas." Fundo teal. Texto rápido. Voiceover directa. Hook forte nos 2 primeiros segundos.', caption: 'Não é café. É ritmo. #energia #burnout #café #fyp #seteecos' },
    conteudoIG: { tipo: 'dica', texto: '3 cafés e ainda te arrastas?', subtitulo: 'Não é café. É ritmo.', caption: '' },
    dica: 'REEL relatable. Fundo TEAL (#5D9B84). Voiceover ElevenLabs. Hook nos 2 primeiros segundos. Objectivo: shares (toda a gente se identifica com café).',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'Quantas vezes engoliste o que querias dizer?',
    eco: 'ecoa',
    template: 'dica',
    formato: 'carrossel',
    cronograma: 'CARROSSEL emocional — publica entre 18h-20h. Cor AZUL OCEANO. Objectivo: SAVES + SHARES.',
    mockups: ['/mockups/Ecoa-dash-portrait.png'],
    hook: 'Quantas vezes engoliste o que querias dizer?',
    corpo: 'Engoliste para manter a paz.\nEngoliste para não incomodar.\nEngoliste porque "não vale a pena".\n\nMas o corpo guardou tudo. A tensão. A dor. O nó na garganta.',
    cta: 'Se reconheces, guarda. Não és só tu.',
    audioScript: 'Quantas vezes engoliste o que querias dizer? Engoliste para manter a paz. Engoliste para não incomodar. Engoliste porque não vale a pena. Mas o corpo guardou tudo. A tensão. A dor. O nó na garganta. Quando calamos a verdade, o corpo fala por nós. O Ecoa ensina-te a recuperar a tua voz. 8 semanas. Passo a passo.',
    instagram: { caption: 'Quantas vezes engoliste o que querias dizer?\n\nO corpo guardou tudo.\n\nSe reconheces, guarda. Não és só tu.\n\nO ECOA: 8 semanas para recuperar a tua voz. Link na bio.\n\n— Vivianne\n\n#voz #expressão #comunicação #silêncio #seteecos #ecoa #maputo' },
    facebook: 'Quantas vezes engoliste o que querias dizer?\n\nO corpo guardou tudo. O ECOA ensina-te a recuperar a voz.\n\n— Vivianne | ECOA',
    whatsapp: 'Quantas vezes engoliste o que querias dizer?\n\nO ECOA: 8 semanas para recuperar a tua voz.\n\n👉 app.seteecos.com/ecoa',
    tiktok: { ideia: 'CARROSSEL azul oceano. Cada slide bate num ponto de silenciamento. Voz suave. Objectivo: identificação e shares.', caption: 'O corpo guardou tudo. #voz #silêncio #comunicação #fyp #seteecos' },
    conteudoIG: {
      tipo: 'carrossel',
      titulo: 'O que engoliste?',
      texto: 'Quantas vezes engoliste o que querias dizer?',
      subtitulo: 'O corpo guardou tudo.',
      caption: '',
      slides: [
        { titulo: 'Quantas vezes engoliste o que querias dizer?', texto: 'Desliza →' },
        { titulo: 'Engoliste para manter a paz.', texto: 'Mas a paz era deles. Não tua.' },
        { titulo: 'Engoliste para não incomodar.', texto: 'Mas incomodaste a ti mesma.' },
        { titulo: 'Engoliste porque "não vale a pena".', texto: 'Mas vale. Tu vales.' },
        { titulo: 'O corpo guardou tudo.', texto: 'A tensão. A dor. O nó na garganta. Quando calamos, o corpo fala por nós.' },
        { titulo: 'Recupera a tua voz.', texto: 'O ECOA: 8 semanas. Passo a passo.\n\nGuarda. Envia a quem precisa.\n\napp.seteecos.com/ecoa' },
      ],
    },
    dica: 'CARROSSEL cor AZUL OCEANO (#4A90A4). 6 slides. Áudio voiceover. Conteúdo de alta identificação emocional.',
  },

  {
    ...
    fase: 3,
    faseTitulo: 'Cada Eco',
    titulo: 'E se pudesses começar do zero? Podes.',
    eco: 'lumina',
    template: 'cta',
    formato: 'reel',
    cronograma: 'REEL de fecho — publica entre 11h-13h. Recap visual de todas as cores. CTA forte para LUMINA.',
    hook: 'Corpo. Valor. Emoção. Foco. Energia. Voz. Identidade. 7 dimensões. 1 sistema.',
    corpo: 'Nas últimas semanas mostrei-te cada peça.\n\nAgora junta tudo: um sistema onde o corpo, o valor, a emoção, o foco, a energia, a voz e a identidade finalmente conversam.\n\nO primeiro passo é grátis. 2 minutos. 23 leituras possíveis.',
    cta: 'Experimenta agora: app.seteecos.com/lumina',
    audioScript: 'Corpo. Valor. Emoção. Foco. Energia. Voz. Identidade. 7 dimensões. 1 sistema. Nas últimas semanas mostrei-te cada peça. Agora junta tudo. Um sistema onde tudo finalmente conversa. O primeiro passo é grátis. 2 minutos. 23 leituras possíveis. Experimenta. Link na bio.',
    instagram: { caption: '7 dimensões. 1 sistema. O primeiro passo é grátis.\n\n2 minutos. 23 leituras possíveis.\n\nQual é a tua? Comenta.\n\nLink na bio.\n\n— Vivianne\n\n#integração #autoconhecimento #transformação #grátis #seteecos #lumina #maputo #moçambique' },
    facebook: '7 dimensões. 1 sistema. O primeiro passo é grátis.\n\nLUMINA: 2 minutos. 23 leituras.\n\n→ app.seteecos.com/lumina\n\n— Vivianne | Sete Ecos',
    whatsapp: '7 dimensões. 1 sistema. O primeiro passo é grátis.\n\nLUMINA: 2 minutos. 23 leituras.\n\n👉 app.seteecos.com/lumina',
    tiktok: { ideia: 'REEL 45s — Transição de cores (verde → dourado → azul → terracota → teal → azul oceano → roxo). Cada eco aparece 2s com a sua cor. Final: "O primeiro passo é grátis. Link na bio."', caption: '7 dimensões. 1 sistema. #seteecos #lumina #integração #fyp' },
    conteudoIG: { tipo: 'cta', texto: '7 dimensões. 1 sistema.', subtitulo: 'O primeiro passo é grátis.', caption: '' },
    dica: 'REEL de fecho. Transição de cores — cada eco com a SUA cor, 2 segundos cada. Voiceover ElevenLabs. CTA forte para LUMINA.',
  },
];
