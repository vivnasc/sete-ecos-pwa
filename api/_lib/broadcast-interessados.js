    ...
    html: (nome) => `
      <div style="font-family: 'Inter', sans-serif; max-width: 600px; margin: 0 auto; background: #FAF6F0; padding: 40px 30px;">
        ...
        <div style="background: linear-gradient(135deg, #C9A96E, #8B6914); border-radius: 12px; padding: 20px; margin: 16px 0; color: white;">
          ...
          <p style="margin: 8px 0 0; font-size: 16px; font-weight: bold;">Desde 499 MZN/mês</p>
          <div style="margin-top: 12px;">
        ...
        <div style="background: white; padding: 16px; border-radius: 12px; margin: 16px 0;">
          ...
          <p style="color: #6B5C4C; font-size: 13px; margin: 2px 0; text-align: center;">M-Pesa | PayPal | Cartão Visa/Mastercard | Transferência Bancária</p>
        </div>
